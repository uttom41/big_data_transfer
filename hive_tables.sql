CREATE TABLE IF NOT EXISTS absent_adjustments (id INT, code STRING, adjustment_date DATE, employee_leave_id INT, employee_id INT, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT, own_approval INT, transaction_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS account_all_balances (id INT, account_id INT, balance_date DATE, center_id INT, amount DECIMAL, account_amount DECIMAL, debit_amount DECIMAL, credit_amount DECIMAL, party_amount DECIMAL, dirty TINYINT) STORED AS ORC

CREATE TABLE IF NOT EXISTS account_ancestors (id INT, account_id INT, ancestor_id INT, ancestor_depth INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS account_balance_update_history (id INT, last_update_time TIMESTAMP, balance_date DATE, branch_id INT, in_transaction INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS account_balances (id INT, account_id INT, balance_date DATE, amount DECIMAL, account_amount DECIMAL, party_amount DECIMAL, dirty TINYINT, branch_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS account_balances_by_branch (id INT, account_id INT, branch_id INT, balance_date DATE, amount DECIMAL, account_amount DECIMAL, party_amount DECIMAL, dirty TINYINT) STORED AS ORC

CREATE TABLE IF NOT EXISTS account_balances_version_two (id INT, account_id INT, balance_date DATE, amount DECIMAL, account_amount DECIMAL, party_amount DECIMAL, dirty TINYINT, branch_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS account_budgets (id INT, account_id STRING, start_date DATE, budgeting_date DATE, type INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS account_cost_center_balances (id INT, cost_center_id INT, account_id INT, balance_date DATE, amount DECIMAL, debit_amount DECIMAL, credit_amount DECIMAL, account_amount DECIMAL, dirty TINYINT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS account_payable_plannings (id INT, vendor_id INT, schedule_date DATE, amount DECIMAL, status INT, cheque_no STRING, bank_id INT, description STRING, inactive TINYINT, deleted TINYINT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, is_rescheduled TINYINT, voucher_no STRING, parent_id INT, paid INT, order_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS account_receivable_plannings (id INT, customer_id INT, schedule_date DATE, amount DECIMAL, status INT, cheque_no STRING, bank_id INT, description STRING, inactive TINYINT, deleted TINYINT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, is_rescheduled TINYINT, voucher_no STRING, parent_id INT, paid INT, order_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS accounts (id INT, number STRING, name STRING, parent_id INT, type INT, description STRING, note STRING, account_number STRING, inactive TINYINT, deleted TINYINT, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, custom_field_4 STRING, custom_field_5 STRING, opening_date DATE, closing_date DATE, opening_balance DECIMAL, credit_limit DECIMAL, created TIMESTAMP, updated TIMESTAMP, created_by INT, bank_id INT, journal_id INT, depth INT, updated_by INT, currency STRING, branch_id INT, center_id INT, account_groups_id INT, project_id INT, back_ref INT, is_approved INT, approved_by INT, approved_at TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS activity_logs (id INT, user_id INT, url STRING, exact_url STRING, `date` DATE, `time` STRING, browser STRING, ip_address STRING, method_request STRING, url_frequency INT, platform STRING, device_type STRING, readable_name STRING, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, end_date DATE, end_time STRING, response_time STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS addresses (id INT, line1 STRING, line2 STRING, line3 STRING, line4 STRING, city_id INT, country_id INT, post_code INT, type INT, thana_id INT, area_id INT, post_office INT, division_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS all_payroll_schedules (id INT, name STRING, print_as STRING, frequency_type INT, type INT, `start` DATE, `end` DATE, check_date DATE, status INT, description STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, parent_id INT, updated_by INT, deleted TINYINT, branch_id INT, batch_payroll_schedule_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS all_payscale_data (id INT, payroll_item_id INT, payscale_id INT, payscale_data_id INT, schedule_id INT, employee_schedule_id INT, employee_id INT, `start` DATE, `end` DATE, amount DECIMAL, partial_amount DECIMAL, yearly_amount DECIMAL, reduced_amount DECIMAL, yearly_reduced_amount DECIMAL, tax_exampted_amount DECIMAL, actual_tax_exampted_amount DECIMAL, taxable_amount DECIMAL, actual_taxable_amount DECIMAL, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, deleted TINYINT, cost_segment_id INT, payment_method INT, show_in_payslip INT, source_schedule INT, subschedule_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS all_products_prices (id INT, product_id INT, code STRING, barcode STRING, base_tp DECIMAL, base_sale_price DECIMAL, effective_sale_price DECIMAL, product_sale_discount DECIMAL, product_sale_discount_2 DECIMAL, promotional_discount DECIMAL, promotional_discount_2 DECIMAL, promotion_id INT, batch_product_price_id INT, customer_category_id INT, membership_card_id INT, branch_id INT, entry_date DATE, effective_date DATE, end_date DATE, start_date DATE, inactive TINYINT, deleted TINYINT, updated TIMESTAMP, created_by INT, created TIMESTAMP, updated_by INT, vendor_id INT, max_mrp DECIMAL, min_mrp DECIMAL, variant_1 INT, variant_2 INT, variant_3 INT, variant_4 INT, variant_5 INT, variant_6 INT, promotional_discount_3_percent DECIMAL, promotional_discount_3 DECIMAL, promotional_discount_4_percent DECIMAL, promotional_discount_4 DECIMAL, promotional_discount_5_percent DECIMAL, promotional_discount_5 DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS alternate_holidays (id INT, employee_id INT, branch_id INT, department_id INT, department_id_2 INT, department_id_3 INT, department_id_4 INT, active_holiday_date DATE, applied_date DATE, entry_date DATE, description STRING, status INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, inactive TINYINT, deleted TINYINT, own_approval INT, transaction_id INT, type INT, leave_type_id INT, leave_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS archives (id INT, table_name STRING, entry_date DATE, column_name STRING, total_record INT, created TIMESTAMP, from_date DATE, to_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS arrears (id INT, employee_id INT, effective_date DATE, type INT, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT, payment_schedule_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS assemble_products (id INT, product_id INT, inventory_id INT, display_name STRING, description STRING, status INT, type INT, assemble_date DATE, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS assessment_schedule (id INT, schedule_code STRING, interview_board_id INT, vacancy_id INT, outline_details_id INT, venue STRING, result_date DATE, start_date DATE, end_date DATE, status INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS assessment_schedule_details (id INT, assessment_schedule_id INT, candidate_id INT, schedule_date DATE, start_time STRING, end_time STRING, inactive INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS assessments (id INT, title STRING, topic STRING, type INT, inactive INT, campaign_id INT, assessment_lead_id INT, assigned_to INT, branch_id INT, project_id INT, model_type INT, training_requisition_id INT, target_party STRING, description STRING, assessment_number STRING, estimated_outcome DECIMAL, budget DECIMAL, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, deleted INT, start_date DATE, end_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS asset_assignments (id INT, assign_date DATE, return_date DATE, asset_category_id INT, item_id INT, product_id INT, department_id INT, branch_id INT, party_id INT, serial STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, deleted TINYINT, status TINYINT, commercial_doc_id INT, asset_master_id INT, confirmed TINYINT, department_level_1 INT, department_level_2 INT, department_level_3 INT, department_level_4 INT, department_level_5 INT, department_level_6 INT, location_level_1 INT, location_level_2 INT, location_level_3 INT, location_level_4 INT, party_type INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS asset_batches (id INT, batch_no STRING, batch_name STRING, description STRING, fiscal_year INT, quarter_no INT, from_date DATE, to_date DATE, type INT, apply_date DATE, posted INT, status INT, product_id INT, voucher_id INT, contra_account_id INT, ar_account_id INT, income_account_id INT, project_id INT, custom_field_1 STRING, day_wise STRING, unit_id INT, branch_id INT, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, total_asset_opening_balance DECIMAL, total_asset_adjustment DECIMAL, total_asset_addition DECIMAL, total_asset_depreciation DECIMAL, total_dispose_amount DECIMAL, total_closing DECIMAL, total_opening_depreciation DECIMAL, cost_center_id INT, month INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS asset_ledger_unique_products (id INT, asset_ledger_id INT, product_id INT, opening_balance DECIMAL, addition DECIMAL, total DECIMAL, depreciation_rate DECIMAL, depreciation_amount DECIMAL, closing_balance DECIMAL, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, till_date DATE, serial STRING, pd_id INT, inactive TINYINT, deleted TINYINT, center_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS asset_ledgers (id INT, voucher_id INT, account_id INT, asset_category_id INT, opening_balance DECIMAL, addition DECIMAL, depreciation_rate DECIMAL, depreciation_amount DECIMAL, closing_balance DECIMAL, total DECIMAL, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, till_date DATE, deleted INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS asset_locations (id INT, assign_date DATE, return_date DATE, asset_management_category_id INT, item_id INT, product_id INT, serial STRING, division STRING, department STRING, party_id INT, section STRING, location STRING, room_no STRING, description STRING, status INT, `current` STRING, branch_id INT, unit_id INT, inactive INT, deleted INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS asset_management_ledgers (id INT, voucher_id INT, product_id INT, asset_serial STRING, asset_product_detail_id INT, delivery_id INT, amount DECIMAL, tx_date DATE, action_type STRING, total DECIMAL, asset_master_id INT, asset_amount DECIMAL, dep_amount DECIMAL, batch_id INT, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, branch_id INT, unit_id INT, cost_center_id INT, project_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS asset_product_details (id INT, asset_batch_id INT, asset_master_id INT, product_id INT, asset_opening_balance DECIMAL, asset_addition DECIMAL, asset_adjustment DECIMAL, asset_closing_balance DECIMAL, dep_opening_balance DECIMAL, dep_adjustment DECIMAL, dep_change DECIMAL, dep_closing_balance DECIMAL, till_date DATE, serial STRING, manual_serial STRING, expense_amount DECIMAL, dispose_amount DECIMAL, status INT, inventory_id INT, depreciation_rate DECIMAL, new_asset_balance DECIMAL, new_dep_balance DECIMAL, change_asset_amount DECIMAL, change_dep_amount DECIMAL, warranty_start DATE, warranty_end DATE, warranty_period DECIMAL, from_date DATE, to_date DATE, duration INT, tender_no STRING, lot_no STRING, package_no STRING, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, entry_date DATE, branch_id INT, unit_id INT, serial_without_prefix STRING, quantity DECIMAL, cost_center_id INT, revaluation_amount DECIMAL, tax_asset_opening_balance DECIMAL, tax_asset_closing_balance DECIMAL, tax_asset_dep_rate DECIMAL, tax_dep_opening_balance DECIMAL, tax_dep_closing_balance DECIMAL, tax_dep_adjustment DECIMAL) STORED AS ORC

CREATE TABLE IF NOT EXISTS asset_product_summaries (id INT, batch_id INT, asset_master_id INT, product_id INT, asset_opening_balance DECIMAL, asset_addition DECIMAL, asset_adjustment DECIMAL, asset_closing_balance DECIMAL, dep_opening_balance DECIMAL, dep_adjustment DECIMAL, dep_change DECIMAL, dep_closing_balance DECIMAL, till_date DATE, serial STRING, manual_serial STRING, expense_amount DECIMAL, dispose_amount DECIMAL, status INT, inventory_id INT, depreciation_rate DECIMAL, new_asset_balance DECIMAL, new_dep_balance DECIMAL, change_asset_amount DECIMAL, change_dep_amount DECIMAL, warranty_start DATE, warranty_end DATE, warranty_period DECIMAL, from_date DATE, to_date DATE, duration INT, tender_no STRING, lot_no STRING, package_no STRING, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, entry_date DATE, unit_id INT, branch_id INT, quantity DECIMAL, assigned TINYINT, cost_center_id INT, project_id INT, converted_to_inventory INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS asset_repairs (id INT, code STRING, unit_id INT, branch_id INT, product_id INT, serial STRING, warranty_start DATE, warranty_end DATE, warranty_period DECIMAL, tender_no STRING, lot_no STRING, package_no STRING, sending_date DATE, return_date DATE, vendor STRING, cost DECIMAL, status STRING, comment STRING, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, inactive INT, deleted INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS attendance (id BIGINT, employee_id INT, shift_id INT, branch_id INT, department_id INT, designation_id INT, entry_date DATE, in_out STRING, in_out_buyer_view STRING, odd_entry TINYINT, leave_type_id INT, taken_days DECIMAL, deduction_amount DECIMAL, holiday_policy_id INT, holiday TINYINT, present_hour DECIMAL, present_hour_buyer_view DECIMAL, working_hour DECIMAL, working_hour_buyer_view DECIMAL, absent TINYINT, short_duration TINYINT, short_presence TINYINT, late TINYINT, late_hour DECIMAL, over_time DECIMAL, over_time_buyer_view DECIMAL, extra_over_time DECIMAL, extra_over_time_buyer_view DECIMAL, raw_over_time DECIMAL, raw_extra_over_time DECIMAL, comment STRING, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, early_out_hour DECIMAL, special_holiday INT, weekends INT, night_shift INT, replacement_leave INT, movement_register_id INT, wfh INT, actual_ot DECIMAL) STORED AS ORC

CREATE TABLE IF NOT EXISTS attendance_adjustment_reason (id INT, title STRING, message STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS attendance_buffer (id INT, employee_id INT, card_id STRING, machine_id STRING, method INT, created TIMESTAMP, in_time STRING, out_time STRING, in_date DATE, out_date DATE, original_entry_time STRING, entry_date DATE, entry_time STRING, original_entry_date DATE, deleted TINYINT, posted TINYINT, wfh INT, dirty INT, updated TIMESTAMP, created_by INT, updated_by INT, status INT, reason STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS attendance_device_data (id BIGINT, employee_id INT, card_id STRING, machine_id STRING, method INT, created TIMESTAMP, entry_time STRING, entry_date DATE, original_entry_time STRING, original_entry_date DATE, deleted TINYINT, posted TINYINT, wfh INT, dirty INT, updated TIMESTAMP, created_by INT, updated_by INT, reason STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS attendance_device_data_raw (id INT, card_id STRING, machine_id STRING, created TIMESTAMP, entry_time STRING, entry_date DATE, deleted INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS attendance_device_data_raw_filter (id INT, card_id STRING, machine_id STRING, created TIMESTAMP, entry_time STRING, entry_date DATE, deleted INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS attendance_schedule_items (id INT, employee_id INT, attendance_schedule_id INT, working_days DECIMAL, present_days DECIMAL, absent_days DECIMAL, late_absent_days DECIMAL, late_hour DECIMAL, total_hour DECIMAL, working_hour DECIMAL, raw_over_time_hour DECIMAL, raw_extra_over_time_hour DECIMAL, over_time_hour DECIMAL, extra_over_time_hour DECIMAL, leave_count DECIMAL, leave_wop_count DECIMAL, total_leave_deduction_amount DECIMAL, full_present INT, piece INT, total_piecework_amount DECIMAL, over_piece INT, present_in_holiday DECIMAL, piece_work_days INT, no_job_days INT, eot_days INT, updated TIMESTAMP, created_by INT, created TIMESTAMP, updated_by INT, inactive INT, deleted INT, early_out_hour DECIMAL, odd_entry_absent_days INT, early_out_absent_days INT, odd_entry_days INT, early_out_days INT, late_days INT, wfh_days DECIMAL, short_leave_days INT, movement_register_count INT, actual_absent_days DECIMAL, requisition_ot_hour DECIMAL, holidays_ot_hour DECIMAL, maternity_leave_start DATE, maternity_leave_end DATE, total_employee_holiday DECIMAL, maternity_leave_days DECIMAL, requisition_ot_hour_two DECIMAL, requisition_ot_hour_four DECIMAL, suspension_days DECIMAL, absent_considering_suspension_days DECIMAL, pms_percentage DECIMAL, sales_based_basic_percentage DECIMAL, sales_incentive_percentage DECIMAL, leave_encashment_amount DECIMAL, sales_count DECIMAL, leave_count_without_el DECIMAL, employee_deposit_amount DECIMAL, employee_sales_force_kpi DECIMAL) STORED AS ORC

CREATE TABLE IF NOT EXISTS attendance_schedules (id INT, name STRING, `start` DATE, `end` DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT, status INT, own_approval INT, transaction_id INT, branch_id STRING, all_payroll_schedule_id STRING, dept_level_1 STRING, dept_level_2 STRING, dept_level_3 STRING, dept_level_4 STRING, job_location_id STRING, cost_center_id INT, employee_ids STRING, paygrade_id STRING, designation_id STRING, employment_type_id STRING, employee_level_id STRING, field_force INT, paygrade_level_id STRING, salary_location_id STRING, department_hierarchy STRING, dept_level_5 STRING, dept_level_6 STRING, leave_data STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS attendance_status (entry_date DATE, verified TINYINT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, created_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS bank_schedule_data (id INT, employee_id INT, account_id INT, schedule_id INT, amount DECIMAL, ta_da_amount DECIMAL, total DECIMAL, `date` DATE, reference_number STRING, status INT, updated TIMESTAMP, updated_by INT, created_by INT, created TIMESTAMP) STORED AS ORC

CREATE TABLE IF NOT EXISTS bank_transactions (id INT, ledger_id INT, bank_date DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS banks (id INT, status INT, back_ref INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS batch_bookings (id INT, product_id INT, barcode STRING, variant_1 INT, variant_2 INT, variant_3 INT, variant_4 INT, variant_5 INT, variant_6 INT, inventory_id INT, quantity DECIMAL, status INT, entry_date DATE, batch_no STRING, order_id INT, doc_type_id INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, from_pipe_line INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS batch_payroll_schedules (id INT, year STRING, month STRING, branch_id_list STRING, payroll_schedule_id_list STRING, status INT, `start` DATE, `end` DATE, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, dept_level_1 STRING, dept_level_2 STRING, dept_level_3 STRING, dept_level_4 STRING, job_location_id STRING, designation_id STRING, employment_type_id STRING, employee_level_id STRING, field_force INT, paygrade_id STRING, paygrade_level_id STRING, salary_location_id STRING, payment_date DATE, dept_level_5 STRING, dept_level_6 STRING, department_hierarchy STRING, name STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS batch_product_prices (id INT, name STRING, effective_date DATE, status INT, inactive TINYINT, deleted TINYINT, updated TIMESTAMP, created_by INT, created TIMESTAMP, updated_by INT, branch_id INT, start_date DATE, end_date DATE, code STRING, applied_branch_id INT, change_type INT, change_percentage DECIMAL, customer_category_id INT, type INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS batch_wise_promotion (id INT, name STRING, start_date DATE, end_date DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, branch_id INT, promotion_type INT, promo_code STRING, status INT, applied_branch_id INT, sub_category_id INT, sub_category_2_id INT, sub_category_3_id INT, sub_category_4_id INT, discount_percent DECIMAL, discount DECIMAL, supp_discount_percent DECIMAL, supp_discount DECIMAL, customer_category_id INT, payment_method INT, vendor_promo_applicable_on INT, payment_method_cash INT, payment_method_credit INT, payment_method_cash_and_card INT, payment_method_emi INT, payment_method_card INT, batch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS bond_consumptions (id INT, con_no STRING, con_date DATE, branch_id INT, invoice_no STRING, invoice_date DATE, pl_no STRING, pl_date DATE, exp_no STRING, exp_date DATE, dc_no STRING, dc_date DATE, be_no STRING, be_date DATE, ep_no STRING, ep_date DATE, sappho_no STRING, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, status INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS bond_ledgers (id INT, bond_id INT, entry_date DATE, year INT, consumption_id INT, party_id INT, invoice_no STRING, invoice_date DATE, ip_no STRING, ip_date DATE, product_id INT, imp_qnty DECIMAL, con_qnty DECIMAL, quantity DECIMAL, amount DECIMAL, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS bonds (id INT, bond_no STRING, entry_date DATE, year INT, status INT, invoice_no STRING, invoice_date DATE, be_no STRING, be_date DATE, bl_no STRING, bl_date DATE, lc_no STRING, lc_date DATE, pi_no STRING, pi_date DATE, ip_no STRING, ip_date DATE, delivery_id STRING, supplier_id INT, import_value DECIMAL, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS branches (id INT, `start` DATE, `end` DATE, employee_id INT, region_id INT, description STRING, full_name STRING, print_as STRING, code STRING, registration_no STRING, founded DATE, website STRING, phone STRING, alt_phone STRING, fax STRING, email STRING, alt_email STRING, mobile STRING, alt_mobile STRING, address_id INT, inactive TINYINT, deleted TINYINT, created_by INT, created TIMESTAMP, updated_by STRING, updated TIMESTAMP, gstin STRING, parent_id INT, rank INT, longitude DECIMAL, latitude DECIMAL, dms_branch_name STRING, dms_branch_code STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS brta_applications (id INT, name STRING, father_name STRING, address STRING, phone_no STRING, nationality STRING, date_of_birth DATE, gurdian_name STRING, serial_1 STRING, serial_2 STRING, year_of_mfg STRING, previous_reg_no STRING, p_o_bank STRING, sex INT, joint_bank STRING, owner_type STRING, hire STRING, hire_purchase STRING, product_id INT, class_of_vehicle STRING, maker_name STRING, type_of_body STRING, maker_country_id INT, colour STRING, number_of_cylinder STRING, fuel_use STRING, horse_power_id INT, rpm_id INT, cubic_capacity_id INT, seat STRING, no_of_standee STRING, wheel_base_id INT, laden_weight_id INT, max_laden_weight_id INT, no_of_tyres STRING, tyres_id INT, no_of_axle STRING, max_axle_weight STRING, overall_length_id INT, overall_width_id INT, overall_height_id INT, created TIMESTAMP, updated TIMESTAMP, created_by STRING, updated_by STRING, inactive TINYINT, deleted TINYINT, branch_id INT, model_name STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS budget_account_summary (id INT, budget_id INT, account_id INT, account_type INT, amount DECIMAL, start_date DATE, end_date DATE, parent_id INT, level_id INT, created_by INT, updated_by INT, approved_by INT, created TIMESTAMP, updated TIMESTAMP, approved_date TIMESTAMP, status INT, deleted INT, inactive INT, description STRING, distribution_id INT, receive_work_order_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS budgets (id INT, budget_id INT, order_count INT, `start` DATE, `end` DATE, amount DECIMAL) STORED AS ORC

CREATE TABLE IF NOT EXISTS business_loan_additional_info (id INT, loan_id INT, penalty_rate DECIMAL, commission DECIMAL, loan_purpose INT, time_limit INT, credit_limit DECIMAL, local_foreign INT, currency STRING, loan_expiry_date DATE, loan_disbursement_date DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS business_loan_histories (id INT, name STRING, number STRING, term INT, loan_id INT, amount DECIMAL, interest_type INT, interest_rate DECIMAL, installment_amount DECIMAL, bank_id INT, loan_issue_date DATE, frequency INT, tenure INT, account_id INT, contra_account_id INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, processing_fee_voucher_id INT, repayment_start_date DATE, processing_fee DECIMAL, type STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS business_loan_payment_vouchers (id INT, loan_id INT, voucher_id INT, payment_category INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, total_payment DECIMAL, principal DECIMAL, monthly_interest DECIMAL, balance DECIMAL, schedule_date DATE, emi_schedule_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS business_loans (id INT, name STRING, number STRING, term INT, type_id INT, amount DECIMAL, interest_type INT, interest_rate DECIMAL, bank_id INT, loan_issue_date DATE, frequency INT, tenure INT, account_id INT, contra_account_id INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, status INT, installment_amount DECIMAL, repayment_start_date DATE, processing_fee DECIMAL, doc_id INT, party_id INT, interest_account_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS cached_account_balances (id INT, account_id INT, balance_date DATE, amount DECIMAL, account_amount DECIMAL, party_amount DECIMAL, dirty TINYINT, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS calls (id INT, start_time STRING, end_time STRING, call_number STRING, related_to STRING, related_to_show STRING, call_subject STRING, description STRING, direction STRING, duration STRING, hours INT, minutes INT, date_created DATE, end_date DATE, modified_by INT, reminder DATE, schedule_call_subject STRING, schedule_date DATE, status INT, assigned_to INT, created_by INT, call_type INT, phone_type STRING, party_type INT, party_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS campaigns (id INT, name STRING, start_date DATE, end_date DATE, type INT, currency STRING, budget DECIMAL, expected_revenue DECIMAL, objective STRING, description STRING, status INT, impression STRING, actual_cost DECIMAL, expected_cost DECIMAL, assign_to INT, team_id INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS candidate_assessments (id INT, `date` DATE, schedule_id INT, vacancy_id INT, candidate_id INT, pannel_id INT, step_id INT, total_marks DECIMAL, full_marks DECIMAL, wieghtage_marks DECIMAL, weightage_max_marks DECIMAL, recommended_by INT, recommended_date DATE, approved_by INT, approved_date DATE, status INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS candidate_positions (id INT, candidate_id INT, vacancy_id INT, status INT, `start` DATE, note STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS candidate_qualifications (id INT, type INT, party_id INT, degree_level INT, trained_level INT, degree_name STRING, training_name STRING, company_name STRING, passing_year INT, start_date DATE, end_date DATE, position STRING, duration_in_year INT, duration_in_month INT, duration_in_days INT, duration_in_hr INT, major_subject STRING, result STRING, board_university STRING, certificate_authority STRING, responsibilities STRING, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS candidates (id INT, code STRING, vacancy_id INT, source_id INT, status INT, application_date DATE, current_designation STRING, current_company STRING, current_salary DECIMAL, expected_salary DECIMAL, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, custom_field_4 STRING, custom_field_5 STRING, custom_field_6 STRING, custom_field_7 STRING, custom_field_8 STRING, custom_field_9 STRING, custom_field_10 STRING, note STRING, provision_period INT, appraisal_duration INT, next_appraisal_date DATE, holiday_policy_id INT, leave_policy_id INT, shift_schedule_id INT, payscale_id INT, schedule_id INT, salary_amount DECIMAL, `start` DATE, manager_1 INT, manager_2 INT, employee_id INT, employment_type INT, confirmation_date DATE, confirmed_salary DECIMAL, employee_start DATE, marks_obtained DECIMAL, recruitment_date DATE, grade_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS cheque_book_leafs (id INT, cheque_number STRING, cheque_book_id INT, status INT, voucher_id INT, issue_date DATE, amount DECIMAL, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, party_id INT, description STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS cheque_books (id INT, cheque_book_no STRING, account_id INT, bank_id INT, branch_id INT, first_cheque_no INT, number_of_leafs INT, issue_date DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, leaf_prefix STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS cheque_status_histories (id INT, cheque_id INT, voucher_id INT, status INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, transaction_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS cheques (id INT, issue_date DATE, cheque_number STRING, account_number STRING, valid_up_to DATE, amount DECIMAL, party_id INT, bank_id INT, created_by INT, updated_by INT, clear_date DATE, cancel_date DATE, journal_id INT, receive_date DATE, account_id INT, type INT, account_name STRING, voucher_id INT, status INT, created TIMESTAMP, updated TIMESTAMP, inactive TINYINT, deleted TINYINT, branch_id INT, cheque_account_id INT, receipt_no STRING, model_id INT, sales_person_1 INT, description STRING, branch STRING, new_issue_date DATE, is_order_paid TINYINT, cheque_book_id INT, cheque_book_leaf_id INT, receipt_book_id INT, receipt_book_leaf_id INT, project_id INT, commercial_doc_id INT, cost_center_id INT, handover_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS cold_storage_bag_delivery_items (id INT, cold_storage_delivery_id INT, sale_order_id INT, voucher_number STRING, bag_delivery_date DATE, amount DECIMAL, paid_amount DECIMAL, due_amount DECIMAL, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, quantity INT, unit_cost DECIMAL, total_amount DECIMAL, accepted TINYINT, original_quantity INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS cold_storage_blacklist (id INT, blacklist_no STRING, blacklist_date DATE, sr_id INT, party_id INT, applier_name STRING, applier_contact_no STRING, status INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, description STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS cold_storage_bookings (id INT, agent_id INT, party_id INT, booking_date DATE, total_quantity DECIMAL, inactive TINYINT, deleted TINYINT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, booking_no STRING, status INT, advance DECIMAL, account_id INT, contra_account_id INT, voucher_id INT, adjusted TINYINT, reference_booking INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS cold_storage_deliveries (id INT, dolil_id INT, party_id INT, delivery_date DATE, total DECIMAL, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, inactive TINYINT, deleted TINYINT, status INT, delivery_no STRING, inventory_id INT, total_loan DECIMAL, account_id INT, contra_account_id INT, voucher_id INT, total_bag DECIMAL, bag_voucher_id INT, sr_id INT, total_carry DECIMAL, completed_by INT, completed_time TIMESTAMP, description STRING, serial INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS cold_storage_dolils (id INT, dolil_no STRING, dolil_date DATE, party_id INT, sr_id INT, via STRING, agent_id INT, bag_delivery_ref_id INT, bag_qty DECIMAL, total DECIMAL, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, status INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS cold_storage_inventories (id INT, name STRING, address_id INT, type INT, inventory_type INT, `start` DATE, `end` DATE, account_id INT, updated TIMESTAMP, updated_by INT, created TIMESTAMP, created_by INT, inactive TINYINT, deleted TINYINT, description STRING, branch_id INT, index INT, wastage_kpi INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS cold_storage_loan_receive (id INT, voucher_id INT, cold_storage_delivery_id INT, loan_type INT, loan_amount DECIMAL, from_date DATE, to_date DATE, days INT, interest_rate DECIMAL, paid_amount DECIMAL, interest DECIMAL, total_loan_amount DECIMAL, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, accepted TINYINT, party_id INT, entry_date DATE, receive_voucher_id INT, payment_method_type INT, account_id INT, contra_account_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS collection_targets (id INT, name STRING, start_date DATE, end_date DATE, branch_id INT, total_target DECIMAL, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS commercial_docs (id INT, type INT, order_number STRING, ref_order_number STRING, parent_doc_id STRING, order_date DATE, completion_date DATE, expected_date DATE, party_id INT, employee_id INT, currency STRING, exchange_rate DECIMAL, src_amount DECIMAL, amount DECIMAL, discount DECIMAL, grand_total DECIMAL, sheet STRING, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, custom_field_4 STRING, custom_field_5 STRING, description STRING, status INT, serial_number INT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, dupamount DECIMAL, src_dupamount DECIMAL, terms STRING, bank_id INT, production_program_id INT, delivery_date DATE, received_date DATE, doc_number STRING, inactive TINYINT, deleted TINYINT, party_address STRING, party_name STRING, requisition_date DATE, att_branch_id INT, branch_id INT, department_id INT, asset_purpose INT, request_level INT, third_party_id INT, ref_bank_id INT, ref_party_id INT, entry_date DATE, outline_id INT, lc_type INT, lc_no STRING, sc_no STRING, indent_agent INT, lc_opening_date DATE, lc_expiry_date DATE, shipment_expiry_date DATE, advising_bank_id INT, container_shipment STRING, port_of_shipment STRING, destination_port STRING, edit_type STRING, revision_number STRING, payment_terms INT, partial_shipment INT, clauses STRING, other_party_id INT, production_no INT, sale_order_id INT, shipping_address STRING, sales_person INT, brand_id INT, provision_1 DECIMAL, reference STRING, attention STRING, subject STRING, completed_by INT, completed_time TIMESTAMP, project_id INT, inventory_id INT, destination_inventory_id INT, approved_by INT, recommend_by INT, approved_time TIMESTAMP, support_duration INT, comments STRING, parent_quotes_id INT, potential_id INT, valid_till DATE, remarks STRING, amount_after_support DECIMAL, implementation_time STRING, shipping_date DATE, shipping_address_id INT, billing_address_id INT, additional_discount_percent DECIMAL, contact_person_id INT, total_tax DECIMAL, vat_percent DECIMAL, `less` DECIMAL, quotation_id INT, use_order_bom_delivery INT, use_order_bom_invoice INT, back_ref STRING, delivery_status INT, custom_field_6 STRING, custom_field_7 STRING, custom_field_8 STRING, custom_field_9 STRING, custom_field_10 STRING, accepted INT, product_id INT, custom_field_11 STRING, back_ref_number STRING, ref_bank_account_number STRING, ref_bank_account_name STRING, ref_bank_branch_name STRING, custom_field_12 STRING, payment_type INT, order_purpose_id INT, price_type INT, cost_center_id INT, incoterms INT, pi_validity_date DATE, account_id INT, voucher_id INT, transaction_id INT, own_approval INT, job_request_id INT, rebate INT, show_qty_sum_display DECIMAL, team_id INT, shipment_term INT, shipping_method INT, inquiry_id INT, order_type_id INT, export_lc_no STRING, export_lc_value DECIMAL, export_days INT, pi_date DATE, import_lc_percent DECIMAL, tc_id INT, bank_branch INT, accep_liability_date DATE, buying_house_name STRING, buyer_order_number STRING, lc_days INT, e_bin STRING, buyer_style_number STRING, swift_code STRING, bblc_value DECIMAL, bblc_no STRING, bblc_date DATE, lc_value DECIMAL, lca_no STRING, irc_no STRING, erc_no STRING, fabric_length STRING, gmts_qnty STRING, bb_ref STRING, applicant_bin_no STRING, applicant_tin_no STRING, issue_bank_bin_no STRING, issue_bank_tin_no STRING, beneficiary_bin_no STRING, beneficiary_tin_no STRING, delivery_term STRING, fabric_origin STRING, insurance_no STRING, insurance_company_id INT, insurance_cover_note STRING, insurance_date DATE, sappo_no STRING, bw_license STRING, bw_license_date DATE, ammendment_no STRING, ammendment_date DATE, ammendment_remarks STRING, port_of_loading STRING, shipping_marks STRING, marketing_person_name STRING, commercial_invoice_no INT, advising_bank_branch INT, sales_con_no STRING, sales_con_date STRING, department_level_1 INT, department_level_2 INT, department_level_3 INT, department_level_4 INT, department_level_5 INT, department_level_6 INT, party_code STRING, grade STRING, dms_backref_modified INT, trade_terms STRING, ait_percent DECIMAL, total_ait DECIMAL, attachment_url STRING, tittle STRING, boq_doc_type INT, boq_rwo_ref_id STRING, doc_signatory_id STRING, bank_signatory_id STRING, buyer_order_id INT, delivery_order_type INT, file_info STRING, vds_type INT, source_tax_type INT, source_tax_percent DECIMAL, total_source_tax DECIMAL, total_vat DECIMAL, delivery_terms_id INT, payment_terms_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS commercial_invoices (id INT, bill_of_lading_no STRING, bill_of_entry_no STRING, bill_of_lading_date DATE, bill_of_entry_date DATE, shipping_mode INT, vessel_name STRING, depart_port STRING, arrival_port STRING, present_dest STRING, shipping_line STRING, etd_date DATE, eta_date DATE, is_accepted TINYINT, acceptance_date DATE, maturity_date DATE, cnf_forwarder_id INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, exp_no STRING, bill_of_exchange STRING, country_of_origin STRING, mlc_no STRING, mlc_date STRING, mlc_value STRING, trade_terms STRING, fabric_not_less DECIMAL, mp_code STRING, mp_name STRING, amounts_in_word STRING, fabric_construction STRING, delivery_challan_no STRING, delivery_challan_date DATE, packing_list_no STRING, packing_list_date DATE, undertaking_no STRING, undertaking_date DATE, bill_of_exchange_date DATE, beneficiary_certificate_ref STRING, beneficiary_certificate_date DATE, certificate_of_origin STRING, certificate_of_origin_date DATE, product_certificate_ref STRING, product_certificate_ref_date DATE, forwarding_ref STRING, forwarding_date DATE, export_permit_no STRING, export_permit_date DATE, pi_lc_required STRING, bblc_received STRING, pi_delivery STRING, fob STRING, raw_material_origin STRING, truck_no STRING, buying_house_code STRING, submit_date DATE, signatory_name STRING, signatory_designation STRING, employee_designation STRING, bank_signatory_code STRING, bank_signatory_name STRING, bank_signatory_designation STRING, claim_usd DECIMAL, claim_percent STRING, claim_amount_in_word STRING, claim_month STRING, fright_collect STRING, to_depz_desig STRING, azo_ref STRING, azo_date DATE, beneficiary_stat_ref STRING, beneficiary_stat_date DATE, claim_ref_no STRING, claim_ref_date DATE, manufacturers_ref STRING, manufacturer_ref_date DATE, packing_certificate_ref STRING, packing_certificate_date DATE, shipment_advice_ref STRING, shipment_advice_date DATE, weight_measure_ref STRING, weight_measure_date DATE, fabric_length_ref STRING, fabric_length_ref_date DATE, inspection_cert_ref STRING, inspection_cert_date DATE, applicants_name STRING, applicants_address STRING, packing_standards STRING, truck_receipts_ref STRING, truck_receipts_date DATE, over_due_interest STRING, doc_present_days STRING, bin_no STRING, no_of_roll STRING, exp_date DATE, doc_submitted_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS commercial_sale_order (id INT, com_doc_id INT, sale_order_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS commission_statement (id INT, lc_id INT, ci_id INT, party_id INT, entry_date DATE, cs_number STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS commissions (id INT, designation_id INT, employee_id INT, commission_percentage DECIMAL, commission_amount DECIMAL, commission_date DATE, sales_target_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS companies (id INT, no_of_share INT, share_unit_price DECIMAL, full_name STRING, print_as STRING, registration_no STRING, founded DATE, website STRING, phone STRING, alt_phone STRING, fax STRING, email STRING, alt_email STRING, mobile STRING, alt_mobile STRING, description STRING, address_id INT, inactive TINYINT, deleted TINYINT, created_by INT, created TIMESTAMP, updated_by STRING, updated TIMESTAMP) STORED AS ORC

CREATE TABLE IF NOT EXISTS company_loan_vouchers (id INT, loan_id INT, voucher_id INT, capital DECIMAL, charge DECIMAL, payment_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS company_loans (id INT, loan_number STRING, name STRING, bank_account_id INT, loan_account_id INT, status INT, type INT, value_date DATE, maturity_date DATE, loan_amount DECIMAL, interest_rate DECIMAL, paid_amount DECIMAL, installment_amount DECIMAL, total_installments INT, paid_installments INT, installment_type INT, next_payment_date DATE, description STRING, created TIMESTAMP, created_by INT, auto_gen INT, updated_by INT, updated TIMESTAMP, doc_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS complain_responses (id INT, employee_id INT, complaint_id INT, response STRING, attachment_url STRING, created DATE, status INT, show_cause_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS complaints (id INT, employee_id INT, complain_no STRING, complain_by INT, on_behalf_of STRING, description STRING, misconduct_id INT, status INT, deleted INT, inactive INT, updated_by INT, created_by INT, created DATE, updated DATE, `start` DATE, `end` DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS cost_center_wise_account_balances (id INT, cost_center_id INT, account_id INT, from_date DATE, to_date DATE, amount DECIMAL, debit_amount DECIMAL, credit_amount DECIMAL, account_amount DECIMAL) STORED AS ORC

CREATE TABLE IF NOT EXISTS courier (id INT, ci_id INT, courier_name STRING, courier_no STRING, description STRING, dispatch_date DATE, receiving_date DATE, receiving_bank_id INT, courier_awb STRING, created_by INT, updated_by INT, deleted TINYINT, inactive TINYINT, created_at TIMESTAMP, updated_at TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS crm_activity (id INT, party_id INT, related_type INT, related_value INT, phone_type INT, phone_number STRING, call_type INT, subject STRING, start_date DATE, assign_employee_id INT, status INT, start_time STRING, end_time STRING, duration INT, description STRING, location STRING, next_activity_date DATE, activity_type INT, activity_result STRING, created TIMESTAMP, updated TIMESTAMP, next_activity_id INT, contact_person_id INT, inactive TINYINT, parent_id INT, created_by INT, updated_by INT, party_type STRING, branch_id INT, activity_number STRING, call_response_status INT, appointment_date DATE, appointment_time STRING, is_satisfied INT, dissatisfaction_reasons STRING, satisfaction_level INT, visitor_id_list STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS crm_b2b_marketings (id INT, title STRING, description STRING, start_time STRING, end_time STRING, duration STRING, hours INT, minutes INT, start_date DATE, end_date DATE, assigned_to INT, related_to INT, related_value INT, status INT, created_by INT, updated_by INT, party_type INT, party_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS crm_bonus (id INT, sales_tier_id INT, employee_id INT, amount DECIMAL, bonus_date DATE, sales_location_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS crm_bonus_details (id INT, bonus_id INT, employee_id INT, amount DECIMAL, bonus_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS crm_campaigns (id INT, branch_id INT, campaign_name STRING, actual_cost DECIMAL, assigned_to INT, budget DECIMAL, description STRING, date_created TIMESTAMP, date_modified TIMESTAMP, expected_leads DECIMAL, start_date DATE, end_date DATE, expected_cost DECIMAL, expected_revenue DECIMAL, frequency INT, campaign_type INT, objective STRING, is_advertise INT, is_tvc INT, is_billboard INT, status INT, next_start_date DATE, next_end_date DATE, month INT, year INT, source_type STRING, source_id INT, created_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS crm_d2d_marketings (id INT, title STRING, description STRING, start_time STRING, end_time STRING, duration STRING, hours INT, minutes INT, start_date DATE, end_date DATE, assigned_to INT, related_to INT, related_value INT, status INT, created_by INT, updated_by INT, party_type INT, party_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS crm_demonstrations (id INT, demonstration_subject STRING, related_to INT, related_value INT, description STRING, location STRING, duration STRING, hours INT, minutes INT, start_time STRING, end_time STRING, start_date DATE, end_date DATE, status INT, assigned_to INT, created_by INT, updated_by INT, call_id INT, party_type INT, party_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS crm_leads (id INT, organization_id INT, organization_contacts_id INT, party_type STRING, title STRING, description STRING, contact_date DATE, campaigns_id INT, leads_source INT, leads_source_description STRING, assign_to INT, lead_owner INT, lead_follower INT, status INT, created TIMESTAMP, modified TIMESTAMP, product_id INT, leads_parent_id INT, opportunity_code STRING, inactive TINYINT, branch_id INT, created_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS crm_meetings (id INT, related_to INT, related_value INT, meeting_subject STRING, meeting_direction STRING, hours INT, minutes INT, description STRING, location STRING, modified_by STRING, schedule_meeting_subject STRING, schedule_date DATE, status STRING, assigned_to INT, start_time STRING, end_time STRING, meeting_date DATE, call_id INT, party_type INT, party_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS crm_presentations (id INT, presentation_subject STRING, related_to INT, related_value INT, description STRING, location STRING, duration STRING, hours INT, minutes INT, start_time STRING, end_time STRING, start_date DATE, end_date DATE, status INT, assigned_to INT, created_by INT, call_id INT, party_type INT, party_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS crm_quotes_transitions (id INT, quote_id INT, re_quote_id INT, status_id INT, prev_status_id INT, remarks STRING, updated_by INT, `date` DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS crm_sales_targets (id INT, name STRING, product_id INT, sales_tier_id INT, designation_id INT, employee_id INT, target_amount DECIMAL, frequency INT, start_date DATE, end_date DATE, sales_location_id INT, month INT, year INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS crp_workcenter_allocation_items (id INT, crp_workcenter_allocation_id INT, prod_unit_id INT, no_of_machines INT, no_of_operators INT, start_date DATE, end_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS crp_workcenter_allocations (id INT, workcenter_id INT, prod_order_id INT, prod_process_id INT, prod_proc_step_id INT, start_date DATE, end_date DATE, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS crp_workcenter_line_alloc_histories (id INT, workcenter_id INT, prod_unit_id INT, machine_addition INT, machine_deduction INT, start_date DATE, operator_deduction INT, operator_addition INT, branch_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS crp_workcenter_line_allocations (id INT, workcenter_id INT, prod_unit_id INT, no_of_machines INT, no_of_operators INT, start_date DATE, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS csi_survey (id INT, title STRING, topic STRING, type INT, start_date DATE, end_date DATE, branch_id INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, description STRING, survey_number STRING, model_type INT, csi_for STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS customer_categories (id INT, type_name STRING, index INT, can_refer TINYINT, self_purchase_point TINYINT, referral_point TINYINT, calculate_point_by_formula TINYINT, fixed_point_percent DECIMAL, service_invoice_shows_quantity TINYINT, service_invoice_shows_unit_cost TINYINT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, party_type STRING, electricity_rate DECIMAL, discount_percent DECIMAL, discount_end_date DATE, discount_not_on INT, discount_not_on_2 INT, discount_not_on_3 INT, depth INT, parent_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS customer_category_change_log (id INT, customer_id INT, category_id INT, `start` DATE, `end` DATE, label STRING, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS customer_inventories (id INT, name STRING, address_id INT, branch_id INT, `start` DATE, `end` DATE, description STRING, inactive INT, deleted INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP) STORED AS ORC

CREATE TABLE IF NOT EXISTS customer_inventory_journals (id INT, commercial_doc_id INT, commercial_doc_item_id INT, delivered_quantity DECIMAL, entry_date DATE, product_id INT, variant_1 STRING, variant_2 STRING, variant_3 STRING, variant_4 STRING, variant_5 STRING, variant_6 STRING, inventory_id INT, inventory_journal_type INT, project_id INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, cost DECIMAL, dirty INT, style_id INT, if_product INT, manufacturing_date DATE, expiry_date DATE, chassis STRING, length STRING, standard_wt_per_kg_feet DECIMAL, standard_wt_per_pcs_kgs DECIMAL, actual_wt_kg_feet DECIMAL, over_less_wt DECIMAL, net_production_wt DECIMAL, wastage DECIMAL, dia_no STRING, product_code STRING, barcode STRING, custom_field_1 INT, party_id INT, qty_pcs DECIMAL, qty_uom DECIMAL, qty_kgs DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS customer_promotions (id INT, name STRING, start_date DATE, end_date DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, branch_id INT, promotion_type INT, promo_code STRING, outline_id INT, status INT, applied_branch_id INT, sub_category_id INT, sub_category_2_id INT, sub_category_3_id INT, sub_category_4_id INT, discount_percent DECIMAL, discount DECIMAL, supp_discount_percent DECIMAL, supp_discount DECIMAL, customer_category_id INT, payment_method INT, vendor_promo_applicable_on INT, payment_method_cash INT, payment_method_credit INT, payment_method_cash_and_card INT, payment_method_emi INT, payment_method_card INT, discount_3_percent DECIMAL, discount_3 DECIMAL, discount_4_percent DECIMAL, discount_4 DECIMAL, discount_5_percent DECIMAL, discount_5 DECIMAL, discount_3_applicable_on INT, discount_4_applicable_on INT, discount_5_applicable_on INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS customer_query (id INT, query_number STRING, query_type INT, query_description STRING, next_activity_id INT, next_activity_date DATE, next_activity_description STRING, branch_id INT, assign_employee_id INT, status INT, execution_time STRING, created TIMESTAMP, created_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS customer_query_customers (id INT, customer_query_id INT, customer_name STRING, phone STRING, sale_date DATE, invoice STRING, party_id INT, address STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS customer_routes (id INT, route_id INT, customer_id INT, start_date DATE, end_date DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS customer_services (id INT, issue_subject STRING, issue_detail STRING, warranty_checking STRING, support_agreement_checking STRING, issue_type INT, issue_origin INT, priority INT, customer_id INT, product_id INT, case_owner INT, status_type INT, status INT, possible_delivery_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS dashboards (id INT, link STRING, tcolumn INT, title STRING, design_css STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, code STRING, menu STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS dcim_device_rack_configs (id INT, rack_id INT, device_type_id INT, device_id INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, continent_id INT, country_id INT, region_id INT, floor_id INT, building_id INT, room_id INT, row_id INT, install_in INT, device_power_type INT, primary_power INT, secondary_power INT, customer_id INT, installation_date DATE, employee_id INT, mounting_side INT, comments STRING, occupied_unit_no INT, start_unit INT, end_unit INT, service_contract_id INT, service_id_list STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS dealer_product_stocks (id INT, customer_id INT, product_id INT, entry_date DATE, previous_stock DECIMAL, current_stock DECIMAL, opening_balance DECIMAL, closing_balance DECIMAL, branch_id INT, area_id INT, zone_id INT, region_id INT, ref_id INT, inactive TINYINT, deleted TINYINT, updated TIMESTAMP, created TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS departments (id INT, name STRING, print_as STRING, code STRING, `start` DATE, `end` DATE, parent_id INT, description STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive TINYINT, depth INT, `order` INT, branch_id INT, branch_id_list STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS designations (id INT, name STRING, print_as STRING, code STRING, department_id INT, parent_id INT, `order` INT, `start` DATE, `end` DATE, description STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive TINYINT, branch_id INT, type INT, level INT, branch_id_list STRING, designation_rank INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS disciplinary_statements (id INT, complain_no STRING, employee_id INT, issue_date DATE, action_id INT, explanation_date DATE, explanation_details STRING, punishment_description STRING, complain_by INT, on_behalf_of STRING, offense_description STRING, committee_description STRING, complain_date DATE, execution_date DATE, notice_period DATE, reason_id INT, type INT, parent_id INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, ref_no STRING, salary_held_start DATE, salary_held_end DATE, complaint_ref_no STRING, committee_members STRING, misconduct_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS discount_provisions (id INT, model_id INT, sub_category_id INT, item_id INT, product_id INT, entry_date DATE, effective_date DATE, provision_1 DECIMAL, provision_2 DECIMAL, provision_3 DECIMAL, provision_4 DECIMAL, provision_5 DECIMAL, created TIMESTAMP, updated TIMESTAMP, created_by STRING, updated_by STRING, inactive TINYINT, deleted TINYINT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS doc_amendments (id INT, com_doc_id INT, amendment_date DATE, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, note STRING, old_amount DECIMAL, new_amount DECIMAL, new_lc_type INT, new_lc_no STRING, new_sc_no STRING, new_party_id INT, new_ref_party_id INT, new_lc_tolerance DECIMAL, new_lc_margin DECIMAL, new_lc_opening_date DATE, new_lc_expiry_date DATE, new_shipment_expiry_date DATE, new_advising_bank_id INT, new_lc_tenor INT, new_partial_shipment INT, new_cnf_id INT, new_transshipment STRING, new_third_party_id INT, new_currency STRING, new_exchange_rate DECIMAL, new_payment_terms INT, old_lc_type INT, old_lc_no STRING, old_sc_no STRING, old_party_id INT, old_ref_party_id INT, old_lc_tolerance DECIMAL, old_lc_margin DECIMAL, old_lc_opening_date DATE, old_lc_expiry_date DATE, old_shipment_expiry_date DATE, old_advising_bank_id INT, old_lc_tenor INT, old_partial_shipment INT, old_cnf_id INT, old_transshipment STRING, old_third_party_id INT, old_currency STRING, old_exchange_rate DECIMAL, old_payment_terms INT, new_applicant_bank_id INT, old_applicant_bank_id INT, new_bank_id INT, amendment_no STRING, old_bank_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS draft_all_employee_schedules (id INT, employee_id INT, schedule_id INT, salary_amount DECIMAL, `start` DATE, `end` DATE, total_amount DECIMAL, paid_amount DECIMAL, comment STRING, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS draft_all_payroll_schedules (id INT, name STRING, print_as STRING, frequency_type INT, type INT, `start` DATE, `end` DATE, check_date DATE, status INT, description STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, parent_id INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS draft_all_payscale_data (id INT, payroll_item_id INT, payscale_id INT, schedule_id INT, employee_schedule_id INT, employee_id INT, `start` DATE, `end` DATE, amount DECIMAL, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS draft_ledgers (id INT, voucher_id INT, account_id INT, amount DECIMAL, entry_date DATE, party_id INT, party_role_id INT, custom_field_1 STRING, src_currency STRING, src_amount DECIMAL, party_currency STRING, party_amount DECIMAL) STORED AS ORC

CREATE TABLE IF NOT EXISTS early_out_adjustments (id INT, code STRING, adjustment_date DATE, employee_leave_id INT, employee_id INT, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT, own_approval INT, transaction_id INT, remarks STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS electric_meters (id INT, service_type_id INT, meter_type_id INT, distribution_phase INT, meter_name STRING, model STRING, manufacturer STRING, nominal_voltage STRING, max_voltage STRING, frequency STRING, warranty_start DATE, warranty_end DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS elm_exam_link (id INT, employee_id INT, validate_till DATE, topic_id INT, question_id STRING, inactive INT, deleted INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, status INT, exam_start_time TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_assets (id INT, employee_id INT, assemble_product_id INT, product_id INT, status INT, `start` DATE, `end` DATE, description STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_claimed_insurances (id INT, insurance_no STRING, employee_id INT, insurance_type_id INT, apply_date DATE, insurance_company STRING, amount DECIMAL, premium DECIMAL, claim_amount DECIMAL, tenure DECIMAL, purpose STRING, family_member_id INT, attachment_id INT, status INT, inactive INT, deleted INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_closing_applications (id INT, employee_id INT, subject STRING, application_date DATE, effect_date DATE, instant_closing TINYINT, type INT, cause STRING, termination_type INT, termination_by INT, retirement_type INT, status INT, status_comments STRING, recommend_by INT, recommend_date DATE, recommend_comment STRING, recommended_effect_date DATE, approved_by INT, approved_date DATE, approved_comment STRING, approved_effect_date DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive TINYINT, deleted TINYINT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_confidential_reports (id INT, name STRING, form_id INT, `date` DATE, status INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, employee_id INT, code STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_evaluation (id INT, employee_id INT, communication INT, interpersonal INT, decision_making INT, leadership INT, listening INT, `date` DATE, updated TIMESTAMP, created_by INT, created TIMESTAMP, comments STRING, status INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_final_settlement_assets (id INT, final_settlement_id INT, item STRING, name STRING, purpose STRING, project STRING, issued_quantity DECIMAL, assign_date DATE, returned_quantity DECIMAL, status INT, receive_date DATE, receive_by INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_final_settlements (id INT, employee_closing_application_id INT, entry_date DATE, payroll_earning_id INT, payroll_payment_id INT, total_addition_amount DECIMAL, total_deduction_amount DECIMAL, net_payable_amount DECIMAL, status INT, voucher_id INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_holidays (id INT, employee_id INT, holiday DATE, alternate_holiday_id INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_insurances (id INT, insurance_no STRING, employee_id INT, insurance_type_id INT, apply_date DATE, insurance_company STRING, amount DECIMAL, premium DECIMAL, inactive INT, deleted INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, is_batch INT, tenure DECIMAL, attachment_id INT, family_member_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_leave_bills (id INT, entry_date DATE, leave_id INT, employee_id INT, payroll_earning_id INT, payroll_payment_id INT, billable_days DECIMAL, rate DECIMAL, amount DECIMAL, status INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_leaves (id INT, leave_type_id INT, employee_id INT, type INT, entry_date DATE, comment STRING, from_date DATE, to_date DATE, is_emergency INT, maternity_status INT, baby_born_date DATE, total_days DECIMAL, approved_to DATE, approved_from DATE, approved_days DECIMAL, deduction_rate DECIMAL, revised TINYINT, status INT, approved_by INT, recommended_by INT, rejected_by INT, canceled_by INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, version INT, deleted TINYINT, location STRING, own_approval INT, transaction_id INT, compensatory_on DATE, half_day INT, quarter_info INT, `start` TIMESTAMP, `end` TIMESTAMP, leave_reliever INT, noc_date DATE, country_id INT, is_overseas INT, is_mandatory INT, is_station INT, considered INT, schedule_id INT, cancel_date DATE, reason STRING, approve_date DATE, reject_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_ledgers (id INT, department_id INT, cost_segment_id INT, account_id INT, contra_account_id INT, journal_id INT, voucher_id INT, entry_date DATE, employee_id INT, employee_schedule_id INT, payroll_schedule_id INT, payroll_earning_id INT, payroll_payment_id INT, payroll_item_id INT, loan_id INT, loan_schedule_id INT, loan_repayment_id INT, bank_id INT, account_number STRING, reason INT, amount DECIMAL, partial_amount DECIMAL, partial_view TINYINT, balance DECIMAL, description STRING, branch_id INT, inactive TINYINT, deleted TINYINT, movement_register_id INT, payment_method INT, show_in_payslip INT, source_schedule INT, subschedule_id INT, system_generated INT, currency_rate DECIMAL, employee_account_detail_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_meal_history (id INT, employee_id INT, entry_date DATE, meal INT, guest_meal INT, inactive INT, deleted INT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_meals (id INT, employee_id INT, `start` DATE, `end` DATE, inactive INT, deleted INT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_meals_applications (id INT, employee_id INT, type INT, status INT, action_date DATE, inactive INT, deleted INT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, transaction_id INT, own_approval INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_notices (id INT, employee_id INT, type TINYINT, termination_id INT, sent_date DATE, cause STRING, signed_by INT, employee_received_date DATE, employee_replay STRING, employee_replay_date DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_payscales (id INT, employee_id INT, payscale_id INT, `start` DATE, `end` DATE, updated_payscale_id INT, edit_type INT, appraisal_id INT, comment STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, use_timedata INT, updated_by INT, amount DECIMAL, taxable_percent DECIMAL, tax_amount DECIMAL, grade_id INT, basic_amount DECIMAL, gross_amount DECIMAL, total_flat_amount DECIMAL, multiply_factor DECIMAL, total_addition DECIMAL, total_deduction DECIMAL, net_amount DECIMAL, previous_payscale_id INT, previous_amount DECIMAL, previous_gross_amount DECIMAL, effective_date DATE, override_payroll_config INT, cash_amount DECIMAL, payscale_grades_slab_details_id INT, payscale_grades_slab_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_payscales_temporary (id INT, employee_id INT, payscale_id INT, `start` DATE, `end` DATE, updated_payscale_id INT, edit_type INT, appraisal_id INT, comment STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, use_timedata INT, updated_by INT, amount DECIMAL, taxable_percent DECIMAL, tax_amount DECIMAL, grade_id INT, basic_amount DECIMAL, gross_amount DECIMAL, total_flat_amount DECIMAL, multiply_factor DECIMAL, total_addition DECIMAL, total_deduction DECIMAL, net_amount DECIMAL, previous_payscale_id INT, previous_amount DECIMAL, previous_gross_amount DECIMAL, effective_date DATE, data STRING, status INT, application_date DATE, transaction_id INT, override_payroll_config INT, change_type INT, impacted INT, designation_id INT, schedule_id INT, payscale_grades_slab_details_id INT, payscale_grades_slab_id INT, from_position_index_id INT, position_type INT, to_position_index_id INT, to_position_index_type INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_performance_appraisals (id INT, title STRING, employee_id INT, outline_id INT, `date` DATE, rating_system_id INT, total_points DECIMAL, weightage_average DECIMAL, rating_points_average DECIMAL, rating_parcentage_average DECIMAL, resulting_rating_point_id INT, status INT, verifier_id INT, approver_id INT, preferred_action_id INT, employment_branch_id INT, designation_id INT, department_id INT, manager_1 INT, manager_2 INT, payscale_id INT, previous_employment_branch_id INT, previous_designation_id INT, previous_department_id INT, previous_manager_1 INT, previous_manager_2 INT, previous_payscale_id INT, current_appraisal_duration INT, next_appraisal_date DATE, salary_increment INT, increment_amount DECIMAL, proposed_salary DECIMAL, description STRING, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, is_partial INT, parent_id INT, frequency_type INT, frequency_value STRING, appraisal_type INT, own_approval INT, transaction_id INT, employee_wise_outline_id INT, comment STRING, effective_date DATE, locked INT, appraisal_scope INT, is_submitted INT, expire_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_positions (id INT, employee_id INT, position_index_id INT, `start` DATE, `end` DATE, created DATE, updated DATE, created_by INT, updated_by INT, type INT, inactive INT, deleted INT, supervisor_position_id INT, manager_position_id INT, is_approver INT, is_recommender INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_purchase_items (id INT, employee_id INT, employee_code STRING, purchase_month_start_date DATE, amount DECIMAL, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_qualifications (id INT, type INT, employee_id INT, degree_level INT, trained_level INT, degree_name STRING, training_name STRING, training_id INT, company_name STRING, passing_year INT, start_date DATE, end_date DATE, position STRING, duration_in_year INT, duration_in_month INT, duration_in_days INT, duration_in_hr INT, major_subject STRING, result STRING, board_university_id INT, certificate_authority STRING, responsibilities STRING, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, location STRING, arranged_by STRING, is_highest INT, description STRING, board_university STRING, board STRING, exam_id INT, experience_type INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_schedules (id INT, employee_id INT, schedule_id INT, `start` DATE, `end` DATE, comment STRING, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employee_session (id INT, name STRING, `start` DATE, `end` DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS employee_setting (id INT, date_hired DATE, paid_upto DATE, release_date DATE, employment_type INT, shift_schedule INT, leave_policy INT, branch INT, department INT, designation INT, payscale INT, payroll_schedule INT, description STRING, updated TIMESTAMP, updated_by INT, name STRING, created_by INT, created TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS employees (id INT, employee_code STRING, birth_certificate_number STRING, card_id STRING, `start` DATE, confirmation_date DATE, `end` DATE, description STRING, liability_update_date DATE, clear_date DATE, release_date DATE, manager_1 INT, manager_2 INT, appraisal_form_id INT, appraisal_duration INT, next_appraisal_date DATE, doctor_recommendation STRING, educational_qualifications STRING, experience_outside_company STRING, reference STRING, release_comment STRING, resignation_date DATE, resignation_comment STRING, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, custom_field_4 STRING, custom_field_5 STRING, custom_field_6 STRING, fingerprint_1 STRING, fingerprint_2 STRING, shift_sequence STRING, inactive_date DATE, completion_status INT, recruitment_date DATE, probation_end DATE, disabled TINYINT, notice_period INT, appraisal_frequency INT, offer_date DATE, appointment_date DATE, salary_cycle_id INT, employee_wise_appraisal_form_id INT, birth_district STRING, visa_expiry_date DATE, visa_no STRING, date_of_expiry DATE, issue_date DATE, is_disable INT, disable_purpose STRING, language INT, is_pieceworker INT, secondary_form_id INT, employee_wise_secondary_form_id INT, next_secondary_appraisal_date DATE, appraisal_secondary_frequency INT, appraisal_secondary_duration INT, ad_username STRING, salary_held_up INT, inactive_unnoticed INT, is_restricted_payment_info TINYINT, is_nightbill INT, is_tiffinbill INT, is_doublemachine INT, is_nightbill2 INT, is_shiftallowance INT, payslip_email STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS enquiry_status_histories (id INT, enquiry_id INT, prev_status INT, present_status INT, change_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS exchange_rates (id INT, src_currency STRING, dest_currency STRING, rate DECIMAL, `start` DATE, `end` DATE, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS exit_clearances (id INT, employee_id INT, last_working_date DATE, entry_date DATE, reason STRING, ref_id STRING, template_id INT, status INT, inactive TINYINT, deleted TINYINT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS export_lc_couriers (id INT, lc_id INT, name STRING, maturity_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS export_lc_documents (id INT, lc_id INT, received_date DATE, lading_date DATE, invoice_date DATE, eta_date DATE, etd_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS files (id INT, file_no STRING, file_name STRING, volume STRING, date_of_opening DATE, type STRING, department_id INT, description STRING, status INT, party_id INT, current_department_id INT, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS files_traverse (id INT, department_from INT, department_to INT, `date` DATE, description STRING, attention STRING, forwarded_by STRING, file_id INT, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, forwarded_to INT, forwarded_to_external STRING, movement_type_id INT, organization_name STRING, received_by STRING, received_by_date DATE, status INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS final_shipment_schedules (id INT, tent_shipment_schedule_id INT, pi_id INT, ci_id INT, total_containers INT, no_of_container INT, factory_dispatch_date DATE, document_date DATE, shipping_date DATE, document_release_date DATE, landing_date_port DATE, landing_date_wh DATE, assessment_date DATE, port_assessment_days INT, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS financial_loans (id INT, outline_id INT, name STRING, account_id INT, loan_no STRING, description STRING, ref_no STRING, calculation_frequency INT, interest_rate DECIMAL, panel_interest_rate DECIMAL, panel_free_days INT, entry_date DATE, applicable_date DATE, end_date DATE, deleted TINYINT, inactive TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, src_currency STRING, src_amount DECIMAL, amount DECIMAL, exchange_rate DECIMAL, base_account_id INT, interest_account_id INT, base_src_amount DECIMAL, interest_src_amount DECIMAL, base_amount DECIMAL, interest_amount DECIMAL, pad_start DATE, pad_end DATE, ltr_start DATE, ltr_end DATE, import_lc_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_accident_info (id INT, fleet_group_id INT, fleet_registration_id INT, accident_date DATE, accident_place STRING, entry_date DATE, note STRING, fleet_schedule_id INT, deleted TINYINT) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_additional_info (id INT, fleet_registration_id INT, fuel_type_id INT, additional_fuel_type_id INT, mileage DECIMAL, renewal_date DATE, notify_renewal_date INT, odometer_type INT, odometer_activation INT, year STRING, make STRING, sitting_capacity INT, engine_number STRING, no_of_cylinders INT, tare DECIMAL, manufacturer DECIMAL, engine_capacity DECIMAL, rwc_no STRING, issue_date DATE, tester_license_no STRING, vehicle_condition INT, transmission INT, engine_type INT, left_hand_drive INT, hybrid INT, air_condition INT, note STRING, chassis_no STRING, color STRING, model_no STRING, owner_id INT, reg_no STRING, key_no STRING, manufacturer_id INT, model_id INT, battery_brand_id INT, battery_size STRING, tyre_brand_id INT, tyre_size STRING, total_mileage DECIMAL, warranty_start_date DATE, warranty_end_date DATE, branch_id INT, fleet_group_id INT, warranty_mileage DECIMAL, ownership_start DATE, ownership_end DATE, branch_name STRING, owner_gid INT, is_posted INT, branch_code STRING, actual_branch_id INT, data_source STRING, is_gvs_module_on INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_asset_vehicle_info (id INT, internal_product_serial_id INT, wo_no STRING, vin_no STRING, plate_no STRING, fuel_type_id INT, odometer_type INT, mileage DECIMAL, odometer_activation DECIMAL, note STRING, renewal_date DATE, make STRING, sitting_capacity INT, engine_number STRING, no_of_cylinders INT, tare DECIMAL, manufacturer DECIMAL, engine_capacity DECIMAL, rwc_no STRING, issue_date DATE, tester_license_no STRING, vehicle_condition INT, transmission INT, engine_type INT, left_hand_drive INT, hybrid INT, air_condition INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_bill_generation (id INT, name STRING, start_date DATE, end_date DATE, outline_id INT, parent_id INT, status INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_bill_generation_details (id INT, bill_generation_id INT, fleet_contracts_id INT, amount DECIMAL, voucher_id INT, party_id INT, start_date DATE, end_date DATE, fleet_schedule_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_driver (id INT, fleet_group_id INT, fleet_registration_id INT, reg_date DATE, note STRING, employee_id INT, location STRING, end_date DATE, name STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_fitness_info (id INT, fleet_registration_id INT, issue_date DATE, expire_date DATE, fitness_note STRING, notify_fitness_expires_on INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_fuel (id INT, fleet_group_id INT, fleet_registration_id INT, refill_date DATE, refill_unit INT, unit_cost DECIMAL, total_cost DECIMAL, fuel_type_id INT, entry_date DATE, deleted TINYINT, note STRING, remaining_adv STRING, odo_before_filing DECIMAL, ending_odo DECIMAL, mileage DECIMAL, employee_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_inspection_info (id INT, fleet_registration_id INT, reference STRING, last_inspection_on DATE, next_inspection_on DATE, notify_next_inspection_on INT, note STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_inspection_notification (id INT, fleet_registration_id INT, fleet_inspection_info_id INT, notification STRING, user_id INT, status INT, entry_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_insurance_expire_notification (id INT, fleet_registration_id INT, fleet_insurance_info_id INT, notification STRING, user_id INT, status INT, entry_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_insurance_info (id INT, fleet_registration_id INT, insurer STRING, insurance_company STRING, reference STRING, insurance_date DATE, insurance_expires_on DATE, notify_insurance_expires_on INT, insurance_note STRING, license_no STRING, license_date DATE, license_expires_on DATE, notify_license_expires_on INT, license_note STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_insurance_license_expire_notification (id INT, fleet_registration_id INT, fleet_insurance_info_id INT, notification STRING, user_id INT, status INT, entry_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_lease_agreement_expire_notification (id INT, fleet_registration_id INT, lease_agreement_id INT, notification STRING, user_id INT, status INT, entry_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_lease_agreement_info (id INT, fleet_registration_id INT, billing_type INT, billing_amount DECIMAL, agreement_no STRING, agreement_amount DECIMAL, agreement_date DATE, activate_from DATE, activate_till DATE, notify_activate_till INT, next_payment_date DATE, note STRING, status INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_on_duty (id INT, fleet_request_id INT, fleet_group_id INT, fleet_registration_id INT, location_from INT, location_to INT, duty_note STRING, employee_id INT, duty_purpose INT, department_id INT, shipment_id INT, schedule_start_date DATE, schedule_end_date DATE, schedule_start_time STRING, schedule_end_time STRING, customer_id INT, mobile_number STRING, package_id INT, agreement_no STRING, agreement_date DATE, agreement_end_date DATE, notify_agreement_end_date INT, agreement_type INT, agreement_amount DECIMAL, booking_days INT, down_payment_rcv DECIMAL, due_billing_amount DECIMAL, next_due_date DATE, notify_next_due_date INT, customer_note STRING, status INT, sub_location_from STRING, sub_location_to STRING, package_price DECIMAL, discount DECIMAL, sub_total DECIMAL, total_agreement_days INT, due_amount DECIMAL, billing_days INT, schedule_type INT, fleet_rout_id INT, fleet_employee_group_id INT, is_hide_info INT, backup_status INT, billed_upto DATE, outline_id INT, total_hours DECIMAL, extra_hours DECIMAL, mileage DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_package (id INT, fleet_group_id INT, package_name STRING, active_from DATE, expires_on DATE, package_type INT, max_hour_day DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_parts (id INT, fleet_registration_id INT, parts_requisition_id INT, use_date DATE, manufacturer STRING, note STRING, entry_date DATE, service_charge DECIMAL, employee_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_parts_requisition (id INT, requisition_type INT, requisition_level INT, branch_id INT, employee_id INT, entry_date DATE, expected_date DATE, requisition_number STRING, fleet_registration_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_pay_advance_driver (id INT, employee_id INT, advance_purpose INT, entry_date DATE, paid_amount DECIMAL, note STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_registration (id INT, registration_number STRING, fleet_type INT, fleet_group_id INT, fleet_id INT, fleet_vin_no STRING, vendor_id INT, address STRING, registration_date DATE, registration_expire_date DATE, notify_registration_expire_date INT, wo_no STRING, inactive TINYINT, plate_no STRING, licence_no STRING, fleet_sl_no INT, product_id INT, product_serial_id INT, seat_capacity INT, manufacturer STRING, vehicle_type INT, usage_type INT, status INT, branch_id INT, vechicle_type INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_registration_expire_notification (id INT, fleet_registration_id INT, notification STRING, user_id INT, status INT, entry_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_renewal_date_notification (id INT, fleet_registration_id INT, fleet_additional_info_id INT, notification STRING, user_id INT, status INT, entry_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_request (id INT, request_number STRING, request_type INT, department_id INT, employee_id INT, request_date DATE, required_date DATE, fleet_group_id INT, region STRING, status INT, `start` TIMESTAMP, `end` TIMESTAMP, duration DECIMAL, destination STRING, total_passenger INT, requester_contact STRING, route_id INT, pickup_location INT, drop_location INT, is_merged INT, request_merged_id INT, left_person INT, department_level_1 INT, department_level_2 INT, department_level_3 INT, department_level_4 INT, department_level_5 INT, department_level_6 INT, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_route_permit_info (id INT, fleet_registration_id INT, issue_date DATE, expire_date DATE, route_permit_note STRING, notify_route_permit_expires_on INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_schedule_agreement_notification (id INT, fleet_schedule_id INT, notification STRING, entry_date DATE, status INT, user_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_schedule_dates (id BIGINT, fleet_schedule_id INT, schedule_date DATE, start_time STRING, end_time STRING, status INT, mileage DECIMAL, total_hours DECIMAL, extra_hours DECIMAL) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_schedule_days (id INT, fleet_schedule_id INT, days INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_schedule_due_date_notification (id INT, fleet_schedule_id INT, notification STRING, entry_date DATE, status INT, user_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_schedule_fleet_list (id INT, fleet_schedule_id INT, fleet_registration_id INT, start_date DATE, end_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_service_notification (id INT, fleet_registration_id INT, fleet_service_id INT, notification STRING, entry_date DATE, status INT, user_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_service_schedule (id INT, fleet_registration_id INT, fleet_services_id INT, entry_date DATE, due_date DATE, notify_due_date INT, note STRING, employee_id INT, status INT, done_date DATE, next_due_date DATE, notify_next_due_date INT, paid_amount DECIMAL, service_from INT, service_date DATE, fleet_id INT, service_package_id INT, start_date DATE, end_date DATE, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, job_id_list STRING, appointment_date DATE, appointment_time STRING, is_posted INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_tax_token_info (id INT, fleet_registration_id INT, issue_date DATE, expire_date DATE, tax_token_note STRING, notify_tax_token_expires_on INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fleet_transaction_management_processes (id INT, voucher_id INT, voucher_amount DECIMAL, income_amount DECIMAL, status INT, entry_date DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT, display_amount INT, type INT, branch_id INT, code STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_trips (id INT, fleet_registration_id INT, trip_date DATE, fleet_driver_id INT, weight DECIMAL, wt_uom INT, starting_location STRING, destination STRING, milage STRING, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS fleet_vehicle_wise_drivers (id INT, fleet_registration_id INT, employee_id INT, name STRING, contact_no STRING, created_by INT, created_at TIMESTAMP, start_date DATE, end_date DATE, inactive INT, deleted INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS fms_budget_details (id INT, budget_id INT, detail_type INT, budget_category_id INT, budget_sub_category_id INT, budget_item_id INT, budget_amount DECIMAL, frequency INT, start_date DATE, end_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS fms_budget_duration_change_history (id INT, budget_id INT, prev_start_date DATE, prev_end_date DATE, extended_end_date DATE, created_by STRING, created_at TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS generic_bill_requisitions (id INT, requisition_number STRING, type INT, status INT, employee_id INT, approved_by INT, `date` DATE, unit_value DECIMAL, rate DECIMAL, inactive INT, deleted INT, updated TIMESTAMP, created TIMESTAMP, updated_by INT, created_by INT, own_approval INT, transaction_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS gift_coupons (id INT, valid_till DATE, discount_percent DECIMAL, coupon_code STRING, coupon_barcode STRING, branch_id INT, inactive TINYINT, deleted TINYINT, updated TIMESTAMP, created TIMESTAMP, created_by INT, updated_by INT, status INT, description STRING, customer_id INT, order_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS gvs_customers (id INT, full_name STRING, phone STRING, mobile STRING, driving_license STRING, category_id INT, subtype INT, ownership_status INT, email STRING, birthday DATE, gender INT, national_id STRING, birth_certificate_number STRING, marriage_day DATE, spouse_name STRING, education STRING, is_posted INT, inactive INT, deleted INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS gvs_id_generator (id INT, key STRING, value INT, status INT, end_value INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS hire_sale_exemption_slab (id INT, month INT, exemption_percentage DECIMAL, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS holiday_types (id INT, frequency INT, name STRING, description STRING, holiday_policy_id INT, weekday INT, monthday INT, month INT, start_date DATE, deleted INT, created_by INT, created TIMESTAMP, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS holidays (id INT, `date` DATE, holiday_type_id INT, frequency INT, holiday_policy_id INT, deleted INT, name STRING, updated TIMESTAMP, created_by INT, description STRING, updated_by INT, created TIMESTAMP, employee_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS hr_cost_center_budgets (id INT, master_id INT, detail_id INT, cost_center_id INT, branch_id INT, department_id INT, cost_segment_id INT, payroll_item_id INT, amount DECIMAL, from_date DATE, to_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS hr_cost_segments (id INT, name STRING, type INT, payroll_item_id INT, `order` INT, segment_code STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS hr_detail_budgets (id INT, master_id INT, from_date DATE, to_date DATE, amount DECIMAL, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS im_devices (id INT, tag STRING, name STRING, pop_id INT, branch_id INT, latitude DECIMAL, longitude DECIMAL, inactive INT, deleted INT, installation_date DATE, employee_id INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, devices_type_id INT, ip_address STRING, serial_no STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS im_encloser (id INT, name STRING, brand_id INT, device_model_id INT, pop_id INT, branch_id INT, latitude DECIMAL, longitude DECIMAL, inactive INT, deleted INT, icon STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, serial_no STRING, installation_date DATE, employee_id INT, device_type INT, status INT, plus_code STRING, device_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS im_end_point_device (id INT, name STRING, serial_no STRING, brand_id INT, device_model_id INT, pop_id INT, branch_id INT, latitude DECIMAL, longitude DECIMAL, inactive INT, deleted INT, icon STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, ip_address STRING, installation_date DATE, employee_id INT, customer_id INT, upstream_device INT, device_type INT, status INT, plus_code STRING, device_id INT, is_visible INT, device_under INT, device_under_type INT, tag STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS im_nttn (id INT, name STRING, inactive INT, deleted INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, serial_no STRING, installation_date DATE, employee_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS im_odf (id INT, name STRING, brand_id INT, device_model_id INT, pop_id INT, branch_id INT, device_under INT, latitude DECIMAL, longitude DECIMAL, inactive INT, deleted INT, icon STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, serial_no STRING, installation_date DATE, employee_id INT, no_of_port INT, device_type INT, status INT, no_of_racks INT, plus_code STRING, device_id INT, device_under_type INT, is_visible INT, rack_unit INT, start_rack_unit_no INT, tag STRING, input_port INT, is_decim_device INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS im_olt (id INT, name STRING, brand_id INT, device_model_id INT, pop_id INT, branch_id INT, device_under INT, latitude DECIMAL, longitude DECIMAL, inactive INT, deleted INT, icon STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, serial_no STRING, ip_address STRING, installation_date DATE, employee_id INT, device_type INT, status INT, plus_code STRING, device_id INT, no_of_port INT, no_of_racks INT, device_under_type INT, is_visible INT, rack_unit INT, start_rack_unit_no INT, no_of_pon_slots INT, no_of_uplink_slots INT, tag STRING, max_split_capacity INT, is_decim_device INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS im_onu (id INT, name STRING, serial_no STRING, brand_id INT, device_model_id INT, pop_id INT, branch_id INT, latitude DECIMAL, longitude DECIMAL, inactive INT, deleted INT, icon STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, ip_address STRING, installation_date DATE, employee_id INT, customer_id INT, connectivity_type_id INT, device_type INT, status INT, plus_code STRING, device_id INT, no_of_port INT, is_visible INT, device_under INT, device_under_type INT, customer_connection_id INT, tag STRING, address STRING, input_port INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS im_rack (id INT, name STRING, pop_id INT, brand_id INT, branch_id INT, device_model_id INT, latitude DECIMAL, longitude DECIMAL, color STRING, description STRING, ins_date TIMESTAMP, inactive INT, deleted INT, icon STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, serial_no STRING, installation_date DATE, employee_id INT, device_type INT, status INT, plus_code STRING, device_id INT, is_visible INT, unit INT, tag STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS im_router (id INT, name STRING, brand_id INT, device_model_id INT, pop_id INT, branch_id INT, device_under INT, device_type_id INT, latitude DECIMAL, longitude DECIMAL, no_of_port INT, inactive INT, deleted INT, icon STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, serial_no STRING, ip_address STRING, installation_date DATE, employee_id INT, device_type INT, status INT, plus_code STRING, device_id INT, customer_id INT, speed_id INT, device_under_type INT, is_visible INT, rack_unit INT, start_rack_unit_no INT, tag STRING, is_decim_device INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS im_sfp (id INT, name STRING, serial_no STRING, brand_id INT, device_type INT, device_model_id INT, pop_id INT, branch_id INT, inactive INT, deleted INT, icon STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, installation_date DATE, employee_id INT, device_id INT, speed_id INT, no_of_port INT, is_decim_device INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS im_splitter (id INT, name STRING, brand_id INT, device_model_id INT, pop_id INT, no_of_port INT, input_port INT, branch_id INT, latitude DECIMAL, longitude DECIMAL, inactive INT, deleted INT, icon STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, serial_no STRING, installation_date DATE, employee_id INT, device_type INT, status INT, plus_code STRING, device_id INT, is_visible INT, device_under INT, device_under_type INT, olt_id INT, olt_port_id INT, tag STRING, source_equipment_position INT, junction_equipment_position INT, address STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS im_switch (id INT, name STRING, brand_id INT, device_model_id INT, pop_id INT, device_under INT, no_of_port INT, upstream_device INT, branch_id INT, latitude DECIMAL, longitude DECIMAL, inactive INT, deleted INT, icon STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, serial_no STRING, ip_address STRING, installation_date DATE, employee_id INT, device_type INT, status INT, bandwidth_id INT, port_no INT, customer_id INT, plus_code STRING, device_id INT, device_under_type INT, upstream_device_type INT, is_visible INT, rack_unit INT, start_rack_unit_no INT, tag STRING, is_decim_device INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS im_tjbox (id INT, name STRING, brand_id INT, device_model_id INT, pop_id INT, branch_id INT, latitude DECIMAL, longitude DECIMAL, serial_no STRING, installation_date DATE, employee_id INT, inactive INT, deleted INT, icon STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, device_type INT, status INT, plus_code STRING, device_id INT, is_visible INT, encloser_type INT, tag STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS im_tr_equipment (id INT, name STRING, brand_id INT, device_model_id INT, pop_id INT, branch_id INT, latitude DECIMAL, longitude DECIMAL, inactive INT, deleted INT, icon STRING, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, serial_no STRING, installation_date DATE, employee_id INT, device_type INT, status INT, plus_code STRING, device_id INT, mux_demux_type INT, ref_mux_id INT, channel_no INT, port_id INT, channel_id INT, port_no INT, is_visible INT, rack_unit INT, start_rack_unit_no INT, device_under INT, device_under_type INT, tag STRING, wdm_type INT, is_decim_device INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS import_lc_couriers (id INT, lc_id INT, name STRING, maturity_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS import_lc_documents (id INT, lc_id INT, received_date DATE, lading_date DATE, invoice_date DATE, eta_date DATE, etd_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS inventories (id INT, name STRING, address_id INT, type INT, inventory_type INT, `start` DATE, `end` DATE, account_id INT, updated TIMESTAMP, updated_by INT, created TIMESTAMP, created_by INT, inactive TINYINT, deleted TINYINT, description STRING, branch_id INT, index INT, wastage_kpi INT, outline_id INT, project_id INT, parent_id INT, depth INT, order_number INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS inventory_journals (id INT, order_id INT, delivery_id INT, delivery_product_id INT, order_product_id INT, delivered_quantity DECIMAL, entry_date DATE, product_id INT, variant_1 INT, variant_2 INT, variant_3 INT, variant_4 STRING, variant_5 STRING, variant_6 STRING, inventory_id INT, inventory_journal_type INT, parent_id INT, project_id INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, cost DECIMAL, voucher_type INT, sale_price DECIMAL, dirty TINYINT, style_id INT, if_product TINYINT, carton_quantity DECIMAL, carton_capacity DECIMAL, manufacturing_date DATE, expiry_date DATE, chassis STRING, length DECIMAL, standard_wt_per_kg_feet DECIMAL, standard_wt_per_pcs_kgs DECIMAL, actual_wt_kg_feet DECIMAL, over_less_wt DECIMAL, net_production_wt DECIMAL, wastage DECIMAL, dia_no DECIMAL, qty_pcs DECIMAL, qty_uom DECIMAL, qty_kgs DECIMAL, product_code STRING, barcode STRING, custom_field_1 STRING, beam_no STRING, roll_number STRING, quality_code STRING, extra_quality_code STRING, qty_points INT, gross_weight DECIMAL, calculated_actual_weight DECIMAL, width_uom DECIMAL, no_of_pieces DECIMAL, grade STRING, plate_no STRING, set_no STRING, display_gross_weight DECIMAL, display_calculated_actual_weight DECIMAL, unit_weight DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS investment_profile_renewals (id INT, investment_id INT, entry_date DATE, issue_date DATE, tenure INT, maturity_date DATE, amount DECIMAL, roi_rate DECIMAL, charge_frequency_id INT, tax_rate DECIMAL, repayment_start_date DATE, remarks STRING, base STRING, status INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS investment_profiles (id INT, name STRING, number STRING, acc_number STRING, type_id INT, branch_id INT, project_id INT, entry_date DATE, issue_date DATE, maturity_date DATE, total_year_days INT, bank_id INT, bank_branch_id INT, interest_rate_history STRING, amount DECIMAL, tenure INT, roi_rate DECIMAL, charge_frequency_id INT, tax_rate DECIMAL, remarks STRING, repayment_start_date DATE, investment_acc_id INT, income_acc_id INT, receivable_acc_id INT, interest_acc_id INT, charge_acc_id INT, ait_acc_id INT, excise_acc_id INT, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, payable_acc_id INT, expense_acc_id INT, employee_associated INT, party_id INT, salary_deduction INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS investment_vouchers_additional_info (id INT, investment_id INT, voucher_id INT, voucher_type INT, interest_receivable_amount DECIMAL, excise_duty_percentage INT, bank_charge_percentage INT, ait_percentage INT, excise_duty_amount DECIMAL, bank_charge_amount DECIMAL, ait_amount DECIMAL, voucher_amount DECIMAL, party_id INT, entry_date DATE, inactive INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS job_requisitions (id INT, requisition_number STRING, request_id INT, position_id INT, `date` DATE, prepared_by INT, proposed_recommender INT, proposed_approver INT, department_id INT, priority INT, branch_id INT, description STRING, status INT, recommended_by INT, recommended_date DATE, approved_by INT, approved_date DATE, inactive TINYINT, deleted TINYINT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, deadline_date DATE, designation_level_id INT, department_level_1 INT, department_level_2 INT, department_level_3 INT, department_level_4 INT, department_level_5 INT, department_level_6 INT, requisition_type INT, man_budget_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS job_vacancies (id INT, status INT, branch_id INT, department_id INT, designation_id INT, type INT, replacement_of INT, no_of_positions INT, opening_date DATE, closing_date DATE, responsibilities STRING, skills STRING, qualifications STRING, experiences STRING, years_of_experience INT, candidate_id INT, created TIMESTAMP, updated TIMESTAMP, created_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS job_works (id INT, invoice_no STRING, party_id INT, billing_address STRING, shipping_address STRING, billing_gstin STRING, shipping_gstin STRING, status INT, type INT, date_of_issue DATE, grand_total DECIMAL, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, description STRING, voucher_ids STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS jobs (id INT, job_title STRING, job_description STRING, department_id INT, designation_id INT, experience INT, age_limit_start INT, age_limit_End INT, salary_type INT, salary_start_range DOUBLE, salary_end_range DOUBLE, vacancy_assessment_outline_id INT, start_date DATE, end_date DATE, branch_id INT, department_level_1 INT, department_level_2 INT, department_level_3 INT, department_level_4 INT, department_level_5 INT, department_level_6 INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS journals (id INT, voucher_id INT, amount DECIMAL, entry_date DATE, party_id INT, project_id INT, party_role_id INT, type INT, description STRING, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, custom_field_4 STRING, custom_field_5 STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, branch_id INT, inactive TINYINT, deleted TINYINT) STORED AS ORC

CREATE TABLE IF NOT EXISTS junk_leads (id INT, crm_leads_id INT, reason STRING, next_contact_date DATE, status INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS late_adjustments (id INT, code STRING, adjustment_date DATE, employee_leave_id INT, employee_id INT, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT, transaction_id INT, own_approval INT, remarks STRING, remarks_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS lc_reminder (id INT, commercial_doc_id INT, subject STRING, priority INT, reminder_type STRING, creation_date DATE, reminder_date DATE, note STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS lcs (id INT, lc_type INT, sale_contact STRING, indent_agent_id INT, tolerance DECIMAL, margin DECIMAL, expiry_date DATE, shipment_expiry_date DATE, partial_shipment TINYINT, lc_tenor_days STRING, transhipment STRING, cnf_forwarder_id INT, btb_limit DECIMAL, lc_product_type_id INT, buyer_exp_lc_no STRING, total_container INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS leads (id INT, status INT, category INT, from_date DATE, assign_to INT, relation INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS leads_type_table (id INT, leads_id INT, opportunity_type_id INT, type_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS leave_balance (id INT, leave_type_id INT, employee_id INT, entry_date DATE, balance DECIMAL, rate DECIMAL, inactive TINYINT, deleted TINYINT, status INT, reason INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, usage_type TINYINT, validity DATE, used DECIMAL, payroll_schedule_id INT, late_deduction_date DATE, compensatory_leave_id INT, expiry_date DATE, notes STRING, exipry_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS leave_cancellation_applications (id INT, leave_id INT, employee_id INT, status INT, reason STRING, inactive INT, deleted INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, apply_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS leave_encashments (id INT, employee_id INT, leave_type_id INT, entry_date DATE, days DECIMAL, amount DECIMAL, status INT, payroll_earning_id INT, payroll_payment_id INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS limited_employee_payroll (id INT, employee_id INT, payroll_item_id INT, `start` DATE, `end` DATE, amount DECIMAL, calculation_type INT, rounding_after INT, multiplier INT, divisor INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS line_wise_card_punch_record (id INT, line_no STRING, card_no STRING, punch_time STRING, `date` DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS lms_books (id INT, name STRING, genre STRING, isbn STRING, edition STRING, published_date DATE, actual_copy INT, current_copy INT, status INT, purchase_price STRING, sale_price DECIMAL, availability_in_lending INT, synopsis STRING, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, image_url STRING, item_id INT, call_number STRING, publisher STRING, publication_place STRING, total_page INT, source_type INT, book_condition STRING, sub_tittle STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS lms_member_book_borrow_requests (id INT, request_number STRING, member_id INT, book_id INT, entry_date DATE, probable_return_date DATE, status INT, approved_date DATE, approved_by INT, rack_id INT, shelf_no INT, quantity INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS loan_amendments (id INT, loan_id INT, loan_amount DECIMAL, installment_amount DECIMAL, interest_rate DECIMAL, next_repayment_date DATE, installments INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, status INT, type INT, application_date DATE, approval_date DATE, repayment_delay INT, repayment_delay_days INT, charge DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS loan_repayments (id INT, employee_id INT, loan_id INT, loan_schedule_id INT, employee_schedule_id INT, loan_type INT, payroll_schedule_id INT, status INT, `date` DATE, amount DECIMAL, principal DECIMAL, interest DECIMAL, description STRING, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS loan_schedules (id INT, schedule_date DATE, employee_id INT, loan_id INT, loan_type INT, amount DECIMAL, principal DECIMAL, paid TINYINT, interest DECIMAL, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive TINYINT, deleted TINYINT, amendment_id INT, delay_months INT, delay_days INT, calculated_interest DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS loans (id INT, entry_date DATE, employee_id INT, status INT, type INT, `start` DATE, `end` DATE, possible_disburse_date DATE, repayment_start_date DATE, interest_rate DECIMAL, loan_amount DECIMAL, interest_amount DECIMAL, total_amount DECIMAL, duration DECIMAL, repayment_mode_id INT, paid_amount DECIMAL, installment_amount DECIMAL, total_installments INT, paid_installments INT, verified_by INT, verification_date DATE, verified_amount DECIMAL, verified_installment INT, verified_installment_amount DECIMAL, priority INT, approved_by INT, approved_date DATE, approved_amount DECIMAL, approved_installment INT, approved_installment_amount DECIMAL, payroll_payment_id INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, description STRING, inactive TINYINT, deleted TINYINT, loan_policy_id INT, repayment_delay_months INT, repayment_delay_days INT, workflow_status INT, own_approval INT, transaction_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS machinery_maintenance_histories (id INT, registered_machine_id INT, machine_id INT, registered_accessory_id INT, accessory_id INT, maintenance_schedule_id INT, scheduled_date DATE, actual_date DATE, scheduled_duration INT, type INT, responsible_person INT, assigned_to INT, product_id INT, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated INT, updated_by TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS machinery_maintenance_job_requests (id INT, code STRING, registered_machine_id INT, registered_accessory_id INT, machine_id INT, accessory_id INT, scheduled_date DATE, scheduled_duration DECIMAL, type INT, machine_type INT, assigned_to INT, product_id INT, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated INT, status INT, updated_by TIMESTAMP, level_id INT, stage_id INT, verdict_id INT, maintenance_reason STRING, priority INT, schedule_id INT, branch_id INT, department_id INT, issue_gen_date DATE, level_id_list STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS machinery_maintenance_schedules (id INT, registered_machine_id INT, registered_accessory_id INT, machine_id INT, accessory_id INT, scheduled_date DATE, scheduled_duration DECIMAL, type INT, machine_type INT, assigned_to INT, product_id INT, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated INT, updated_by TIMESTAMP, code STRING, job_request_id INT, level_id INT, stage_id INT, verdict_id INT, branch_id INT, notification_status INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS machines (id INT, name STRING, machine_number STRING, start_time STRING, end_time STRING, type STRING, block STRING, machine_gg STRING, line_number STRING, finished_product_size STRING, `start` DATE, status INT, factory_id INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS manpower_budget_requisitions (id INT, man_budget_id INT, quantity INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, man_budget_details_id INT, status INT, own_approval INT, transaction_id INT, `date` DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS manpower_budgets (id INT, name STRING, start_year DATE, end_year DATE, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, status INT, own_approval INT, transaction_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS meetings (id INT, source_type INT, source_id INT, party_id INT, type INT, title STRING, notes STRING, initiated_by INT, created TIMESTAMP, updated TIMESTAMP, updated_by INT, created_by INT, inactive INT, deleted INT, template_id INT, meeting_url STRING, code STRING, meeting_date DATE, start_time STRING, end_time STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS member_sales_target (id INT, sales_target_location_id INT, employee_id INT, amount DECIMAL, name STRING, frequency INT, start_date DATE, end_date DATE, year INT, month_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS member_sales_target_members (id INT, member_sales_target_id INT, employee_id INT, start_date DATE, end_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS mms_bookings (id INT, payment_method_type INT, booking_type INT, loading_port_id INT, destination_port_id INT, etd DATE, eta DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS mms_shipments (id INT, shipment_number STRING, shipment_date DATE, origin_port INT, destination_port INT, shipping_method_id INT, shipment_term_id INT, status INT, buyer_order_id INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, inactive INT, deleted INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS mnf_manufacturing_doc_items (id INT, doc_id INT, item_id INT, style_id INT, style_type_id INT, smv DECIMAL, fabrication STRING, buyer_target_price DECIMAL, estimated_price DECIMAL, quantity INT, has_sample INT, etd DATE, payment_mode INT, comments STRING, designer STRING, technical_designers STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT, style_description STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS mnf_manufacturing_docs (id INT, code STRING, type INT, branch_id INT, buyer_id INT, buyer_inquiry_no INT, agent_id INT, season_id INT, description STRING, merchandiser_id INT, manager_id INT, currency STRING, receive_date DATE, quot_send_date DATE, status INT, contact_person_info STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT, team_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS movement_registers (id INT, employee_id INT, entry_date DATE, from_date DATE, to_date DATE, approved_to DATE, approved_from DATE, total_days INT, approved_days INT, approved_by INT, recommended_by INT, rejected_by INT, cancelled_by INT, status INT, place STRING, purpose_of_visit INT, created_by INT, updated_by INT, inactive INT, version INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, comment STRING, charging_code STRING, mode_of_travel STRING, conveyance_bill_amount DECIMAL, voucher_id INT, start_time STRING, end_time STRING, transaction_id INT, own_approval INT, not_return INT, card_id STRING, employee_code STRING, time_duration STRING, reason INT, remark STRING, check_in STRING, check_out STRING, type INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS mrp_purchase_orders (id INT, wo_id INT, po_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS multi_cheque_details (id INT, multi_cheque_id INT, account_id INT, party_id INT, bank_id INT, cheque_amount DECIMAL, description STRING, cheque_number STRING, cheque_date DATE, voucher_id INT, account_number STRING, cheque_book_id INT, cheque_book_leaf_id INT, project_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS multi_cheque_vouchers (id INT, multi_cheque_id INT, voucher_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS multi_cheques (id INT, amount DECIMAL, description STRING, multicheque_number STRING, multicheque_date DATE, status INT, type INT, inactive TINYINT, deleted TINYINT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, party_type STRING, party_id INT, account_id INT, branch_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS multipliers (id INT, name STRING, value DECIMAL) STORED AS ORC

CREATE TABLE IF NOT EXISTS new_joiners_orientation (id INT, name STRING, description STRING, code STRING, `date` DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, deleted_by INT, inactive INT, deleted INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS new_joiners_orientation_details (id INT, orientation_id INT, topic_id INT, organizer STRING, `date` DATE, `time` DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, deleted_by INT, inactive INT, deleted INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS odd_entry_adjustments (id INT, code STRING, adjustment_date DATE, employee_leave_id INT, employee_id INT, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT, transaction_id INT, own_approval INT, remarks STRING, end_time STRING, device_data_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS opportunities (id INT, name STRING, campaign_id INT, currency STRING, amount DECIMAL, next_step STRING, source_id INT, party_id INT, type INT, assign_to INT, team_id INT, description STRING, status INT, closing_date DATE, profitability DECIMAL, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS order_invoices (id INT, invoice_number STRING, invoice_date DATE, received_date DATE, order_id INT, invoice_amont DECIMAL, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS order_item_warranty_negotiations (id INT, order_id INT, product_id INT, serial STRING, party_id INT, warranty_duration INT, warranty_start_date DATE, warranty_end_date DATE, created_by INT, updated_by INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, description INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS order_sheets (id INT, party_id INT, order_date DATE, delivery_date DATE, type INT, slat_id INT, box_color STRING, slat_color STRING, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, total_cwidth DECIMAL, total_cheight DECIMAL, total_tube DECIMAL, total_gch_length DECIMAL, total_slat_qty DECIMAL, total_swidth DECIMAL, end_slat DECIMAL, total_tpcs DECIMAL, custom_field_1 STRING, total_order DECIMAL, description STRING, project_id INT, party_type STRING, status INT, approved_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS package_products (id INT, package_id INT, product_id INT, unit_cost DECIMAL, quantity DECIMAL, `start` DATE, status INT, updated TIMESTAMP, created_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS packages (id INT, name STRING, status INT, `start` DATE, `end` DATE, description STRING, updated TIMESTAMP, created_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS packing (id INT, order_no INT, delivery_no INT, type INT, party_id INT, total_qty DECIMAL, country_of_origin INT, bill_to INT, shipping_address STRING, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, branch_id INT, `date` DATE, name STRING, code STRING, product_id INT, outline STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS parties (id INT, first_name STRING, last_name STRING, middle_name STRING, full_name STRING, full_name_bn STRING, print_as STRING, title INT, nick STRING, suffix STRING, gender INT, birthday DATE, marital_status INT, comment STRING, passport STRING, national_id STRING, phone STRING, alt_phone STRING, email STRING, alt_email STRING, mobile STRING, alt_mobile STRING, fax STRING, website STRING, created TIMESTAMP, created_by INT, updated TIMESTAMP, subtype INT, role INT, parent_id INT, updated_by INT, opening_balance DECIMAL, entry_date DATE, journal_id INT, branch_id INT, code STRING, barcode STRING, pin_number STRING, currency STRING, inactive TINYINT, deleted TINYINT, type STRING, late_fee_policy_id INT, religion STRING, religion_id INT, nationality STRING, father_name STRING, mother_name STRING, spouse STRING, no_of_children INT, height STRING, weight STRING, blood_group STRING, credit_limit DECIMAL, credit_limit_check TINYINT, credit_days INT, blocked TINYINT, skype STRING, phone_prefix STRING, whatsapp STRING, facebook STRING, party_group_id INT, credit_days_check TINYINT, gstin STRING, shipping_gstin STRING, shipping_careof STRING, miscellaneous_data STRING, meter_id INT, meter_number STRING, bin STRING, etin STRING, service_package_id INT, service_contract_id INT, marriage_day DATE, additional_branches_id STRING, alt_mob_prefix STRING, mob_prefix STRING, bank_type INT, is_approved INT, approved_by INT, approved_at TIMESTAMP) STORED AS ORC

CREATE TABLE IF NOT EXISTS party_accounts (id INT, party_id INT, account_name STRING, account_number STRING, opening_date DATE, bank_id INT, routing_number STRING, type INT, `start` DATE, `end` DATE, created TIMESTAMP, created_by INT, updated TIMESTAMP, description STRING, is_default INT, updated_by INT, inactive TINYINT, deleted TINYINT, bank_branch_id INT, customer_id STRING, card_number STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS party_activities (id INT, subject STRING, employee_id INT, party_id INT, party_type_str STRING, contact_id INT, person STRING, phone_number STRING, email STRING, address STRING, designation STRING, start_date DATE, end_date DATE, description STRING, activity_type INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, model_name STRING, model_id INT, status INT, public_private INT, priority INT, start_time STRING, end_time STRING, activity_action_id INT, parent_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS party_addresses (id INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, party_id INT, address_id INT, `start` DATE, `end` DATE, type INT, is_primary TINYINT, `order` INT, inactive TINYINT, deleted TINYINT, updated_by INT, default INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS party_ledgers (id INT, journal_id INT, voucher_id INT, entry_date DATE, party_id INT, party_role_id INT, amount DECIMAL, src_currency STRING, src_amount DECIMAL, description STRING, project_id INT, branch_id INT, inactive TINYINT, deleted TINYINT) STORED AS ORC

CREATE TABLE IF NOT EXISTS party_nominees (id INT, name STRING, marital_status INT, relation INT, type INT, dob DATE, present_address_id INT, permanent_address_id INT, percentage DECIMAL, party_id INT, national_id STRING, birth_certificate STRING, inactive TINYINT, deleted TINYINT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, address STRING, mobile STRING, employee_family_member_id INT, nominee_guardian_id INT, nominee_guardian_relationship INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS party_roles (id INT, party_id INT, type INT, `start` DATE, `end` DATE, role_number STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS party_supervisors (id INT, party_id INT, party_role STRING, other_party_id INT, other_party_role STRING, start_date DATE, end_date DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, organogram_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS payroll_earnings (id INT, name STRING, bonus_id INT, entry_date DATE, status INT, description STRING, payroll_item_id INT, account_id INT, voucher_id INT, reason INT, amount DECIMAL, payroll_schedule_id INT, contra_account_id INT, branch_id INT, deleted TINYINT, `percent` DECIMAL, inactive TINYINT, created TIMESTAMP, created_by INT, cost_segment_id INT, refundable_deduction TINYINT, tax_deduction TINYINT, workflow_status INT, transaction_id INT, own_approval INT, start_from DATE, end_at DATE, revenue_stamp_deduction INT, pf_deduction INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS payroll_payments (id INT, entry_date DATE, reason INT, name STRING, amount DECIMAL, status INT, description STRING, payroll_item_id INT, payroll_earning_id INT, payroll_schedule_id INT, account_id INT, voucher_id INT, contra_account_id INT, branch_id INT, is_regular_payment TINYINT, payment_method_type INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, payroll_earning_id_list STRING, workflow_status INT, own_approval INT, transaction_id INT, start_from DATE, end_at DATE, multicurrency_gain_loss_amount DECIMAL) STORED AS ORC

CREATE TABLE IF NOT EXISTS payroll_reimbursements (id INT, employee_id INT, schedule_id INT, payroll_item_id INT, entry_date DATE, ref_doc_number STRING, amount DECIMAL, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS payroll_schedules (id INT, name STRING, print_as STRING, frequency_type INT, type INT, `start` DATE, `end` DATE, check_date DATE, description STRING, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, parent_id INT, updated_by INT, branch_id INT, branch_id_list STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS pdi_survey (id INT, title STRING, topic STRING, type INT, target_party STRING, estimated_outcome DECIMAL, budget DECIMAL, start_date DATE, end_date DATE, campaign_id INT, survey_lead_id INT, assigned_to INT, branch_id INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, description STRING, survey_number STRING, project_id INT, model_type INT, training_requisition_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS pdi_survey_basics (id INT, survey_number STRING, title STRING, description STRING, survey_type STRING, start_date DATE, end_date DATE, project_id INT, inactive INT, deleted INT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, parent_survey_basic_id INT, survey_stage INT, template_for STRING, engine_no STRING, chassis_no STRING, template_id INT, has_performed INT, level INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS performance_score_summaries (id INT, appraisal_id INT, total_rating_point DECIMAL, total_weightage_rating_score DECIMAL, status INT, employee_id INT, appraisal_date DATE, frequency_type INT, frequency_value STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS piece_rates (id INT, description STRING, piece_id INT, order_id INT, order_product_id INT, local_rate DECIMAL, exchange_rate DECIMAL, rate_in_secondary_currency DECIMAL, from_date DATE, to_date DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, code STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS piecework_employees (id INT, employee_id INT, piece_id INT, order_id INT, min_target DECIMAL, target_type INT, assigned_from DATE, assigned_to DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, order_product_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS pieceworks (id INT, employee_id INT, department_id INT, schedule_id INT, entry_date DATE, rate DECIMAL, quantity INT, comment STRING, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, order_id INT, order_product_id INT, piece_id INT, rate_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS plan_products (id INT, plan_id INT, product_id INT, unit_cost DECIMAL, discount_per_product DECIMAL, quantity DECIMAL, `start` DATE, status INT, updated TIMESTAMP, created_by INT, total DECIMAL, variant_1 INT, variant_2 INT, variant_3 INT, variant_4 INT, variant_5 INT, variant_6 INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS plans (id INT, name STRING, status INT, `start` DATE, `end` DATE, description STRING, updated TIMESTAMP, created_by INT, currency STRING, total DECIMAL, deleted TINYINT, inactive TINYINT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS position_indices (id INT, position_id STRING, parent_id INT, dept_level_1 INT, dept_level_2 INT, dept_level_3 INT, dept_level_4 INT, dept_level_5 INT, dept_level_6 INT, inactive INT, deleted INT, employee_id INT, `start` DATE, `end` DATE, designation_id INT, created_by INT, updated_by INT, created DATE, updated DATE, dept_detail_id_1 INT, dept_detail_id_2 INT, dept_detail_id_3 INT, dept_detail_id_4 INT, dept_detail_id_5 INT, dept_detail_id_6 INT, position_level INT, job_location_id INT, branch_id INT, is_posted INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS post_vacancy (id INT, posting_number STRING, vacancy_id INT, agency_id INT, status INT, entry_date DATE, posting_date DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive TINYINT, deleted TINYINT, backref INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS post_vacancy_summary_info (id INT, post_vacancy_id INT, posting_number STRING, vacancy_number STRING, position_id STRING, position_code STRING, job_title STRING, job_details_url_endpoint STRING, allowed_departments STRING, expired_date DATE, manpower_quantity INT, status INT, is_notified INT, job_thumbnail_url STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS potential (id INT, potential_name STRING, potential_owner_id INT, leads_id INT, next_step STRING, description STRING, amount DECIMAL, expected_revenue DECIMAL, sales_stage_id INT, probability INT, closing_date DATE, status INT, potential_code STRING, inactive TINYINT, branch_id INT, created_by INT, entry_date DATE, top_deal INT, classification STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS potential_sales_stage_changes (id INT, potential_id INT, sales_stage_id INT, updated_by INT, `date` DATE, remarks STRING, prev_sales_stage_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS potential_status_changes (id INT, potential_id INT, status INT, prev_status INT, updated_by INT, `date` DATE, remarks STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS pre_costing (id INT, name STRING, production_id STRING, entry_date DATE, production_date DATE, factory_id INT, ordered_product_qty INT, predicted_total_raw_cost DECIMAL, predicted_other_expense DECIMAL, predicted_production_cost DECIMAL, status INT, currency STRING, exchange_rate DECIMAL, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, workorder_id INT, production_program_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS prod_mps_line_allocs (id INT, prod_order_id INT, prod_process_id INT, prod_proc_step_id INT, start_date DATE, `start` TIMESTAMP, duration INT, duration_hr INT, end_date DATE, `end` TIMESTAMP, branch_id INT, project_id INT, unit_id INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, no_of_machines INT, no_of_operators INT, available_machines INT, free_machines INT, workcenter_id INT, locked INT, status INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS prod_order_master_plannings (id INT, prod_order_id INT, prod_process_id INT, prod_proc_step_id INT, start_date DATE, `start` TIMESTAMP, duration INT, duration_hr INT, end_date DATE, `end` TIMESTAMP, branch_id INT, project_id INT, unit_id INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, workcenter_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS prod_packages (id INT, prod_order_id INT, net_weight DECIMAL, dimension STRING, packing_date DATE, package_number STRING, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, barcode STRING, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS prod_schedule_infos (id INT, code STRING, name STRING, opening_date DATE, ending_date DATE, prod_unit_id INT, parent_id INT, entry_date DATE, auto_create_pattern STRING, is_auto INT, status INT, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, prod_industry_type_id INT, schedule_type STRING, is_holiday INT, holiday_type_id INT, holiday_id INT, year_type STRING, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS prod_shipments (id INT, prod_order_id INT, shipment_date DATE, destination STRING, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS product_batch_products (id INT, expiry_information DATE, product_id INT, product_barcode STRING, product_sku STRING, entry_date DATE, expiry_applicable INT, expiry_duration INT, expiry_start_date DATE, expiry_end_date DATE, product_batch_id INT, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS product_batches (id INT, label STRING, code STRING, identification_code STRING, product_id INT, entry_date DATE, product_barcode STRING, product_sku INT, warranty_applicable INT, warranty_period INT, expiry_applicable INT, expiry_duration INT, expiry_start_date DATE, expiry_end_date DATE, has_serial INT, serial_length INT, serial_start STRING, serial_end STRING, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, voucher_id INT, status INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS product_boms (id INT, product_id INT, entry_date DATE, description STRING, mrp DECIMAL, calculated_mrp DECIMAL, whole_sale_price DECIMAL, status INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS product_expiries (id INT, inventory_id INT, inventory_product_id INT, delivery_product_id INT, batch_no STRING, product_id INT, expiry_date DATE, quantity DECIMAL, type INT, order_id INT, custom_field_1 STRING, custom_field_2 STRING, created_by INT, created TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS product_price_histories (id INT, item_id INT, product_id INT, effective_date_from DATE, effective_date_to DATE, sale_price DECIMAL, sale_price2 DECIMAL, sale_price3 DECIMAL, provision_1 DECIMAL, provision_2 DECIMAL, provision_3 DECIMAL, provision_4 DECIMAL, provision_5 DECIMAL, created TIMESTAMP, updated TIMESTAMP, created_by STRING, updated_by STRING, inactive TINYINT, deleted TINYINT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS product_sales_summary (id INT, product_id INT, branch_id INT, quantity DECIMAL, cost DECIMAL, sale_price DECIMAL, entry_date DATE, from_date DATE, to_date DATE, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, custom_field_4 STRING, status INT, state INT, description STRING, created TIMESTAMP, created_by STRING, inactive TINYINT, deleted TINYINT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS product_serials (id INT, product_id INT, order_no STRING, delivery_no STRING, serial STRING, serials STRING, sl_prefix STRING, sl_start BIGINT, sl_end BIGINT, sl_suffix STRING, sl_count BIGINT, sl_length BIGINT, serial_1 STRING, serial_2 STRING, serial_3 STRING, serial_4 STRING, serial_5 STRING, file_id INT, lot_number STRING, entry_date DATE, expiry_date DATE, reference_number STRING, warranty_start DATE, div_no INT, warranty_end DATE, warranty_period INT, status INT, deleted TINYINT, inactive TINYINT, file TINYINT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, delivery_ref_number STRING, description STRING, branch_id INT, inventory_id INT, is_transfer TINYINT, delivery_type INT, faulty_status INT, fc_ok_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS product_settings_emi (id INT, item_id INT, product_id INT, effect_date_start DATE, effect_date_end DATE, min_tenure INT, max_tenure INT, min_dp_percent DECIMAL, branch_id INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, inactive INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS product_wise_sales_data (id INT, entry_date DATE, product_id INT, amount DECIMAL, service INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS product_wise_salestargets (id INT, name STRING, branch_id INT, customer_id INT, distribution_method_id INT, start_year DATE, end_year DATE, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS product_wise_salestargets_distributions (id INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, target_id INT, parent_id INT, amount DECIMAL, start_date DATE, end_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS production_orders (id INT, order_id INT, order_number STRING, factory_id INT, entry_date DATE, schedule_date DATE, start_date DATE, end_date DATE, status INT, manager_1 INT, manager_2 INT, description STRING, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS production_planning (id INT, production_id INT, production_step_id INT, entry_date DATE, machine_id INT, employee_id INT, workorder_id INT, start_time STRING, end_time STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS production_products_forward (id INT, production_id INT, source_step_id INT, destination_step_id INT, workorder_id INT, entry_date DATE, product_id INT, quantity DECIMAL, inventory_product_id INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS production_program_values (id INT, production_program_id INT, step_id INT, substep_id INT, `order` INT, code STRING, expected_date DATE, offset INT, actual_date DATE, reason STRING, object_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS production_programs (id INT, name STRING, shipment_date DATE, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, outline_id INT, party_id INT, employee_id INT, style_number STRING, po_number STRING, item_name STRING, quantity DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS program_book (id INT, particular_work_type_id INT, branch_id INT, figure INT, unit_of_measurement_id INT, men INT, women INT, casual INT, total INT, employee_1 INT, employee_2 INT, employee_3 INT, remarks STRING, creation_date DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, program_book_number STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS project_employees (id INT, hr_project_id INT, project_id INT, employee_id INT, start_date DATE, end_date DATE, involvement_ratio DECIMAL, inactive TINYINT, deleted TINYINT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS projects (id INT, name STRING, party_id INT, address_id INT, start_date DATE, end_date DATE, type INT, description STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, amount DECIMAL, updated_by INT, inactive TINYINT, deleted TINYINT, branch_id INT, project_group_id INT, code STRING, latitude DECIMAL, longitude DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS promotional_gifts (id INT, branch_id INT, customer_category_id INT, from_date DATE, to_date DATE, status INT, name STRING, code STRING, total DECIMAL, inactive TINYINT, deleted TINYINT, updated TIMESTAMP, created TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS promotions (id INT, name STRING, start_date DATE, end_date DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, branch_id INT, promotion_type INT, promo_code STRING, outline_id INT, status INT, applied_branch_id INT, sub_category_id INT, sub_category_2_id INT, sub_category_3_id INT, sub_category_4_id INT, discount_percent DECIMAL, discount DECIMAL, supp_discount_percent DECIMAL, supp_discount DECIMAL, customer_category_id INT, payment_method INT, vendor_promo_applicable_on INT, payment_method_cash INT, payment_method_credit INT, payment_method_cash_and_card INT, payment_method_emi INT, payment_method_card INT, discount_3_percent DECIMAL, discount_3 DECIMAL, discount_4_percent DECIMAL, discount_4 DECIMAL, discount_5_percent DECIMAL, discount_5 DECIMAL, discount_3_applicable_on INT, discount_4_applicable_on INT, discount_5_applicable_on INT, sale_invoice_min_amount DECIMAL, sale_invoice_max_amount DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS qm_qc_inspections (id INT, qc_number STRING, branch_id INT, product_id INT, qc_template_id INT, entry_date DATE, entry_time STRING, source_type STRING, source_id INT, prod_run_id INT, prod_proc_step_id INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS qm_qc_registers (id INT, qc_number STRING, branch_id INT, product_id INT, qc_template_id INT, entry_date DATE, entry_time STRING, source_type STRING, source_id INT, prod_run_id INT, prod_proc_step_id INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, qc_inspection_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS rainfall_record (id INT, `date` DATE, `time` STRING, rainfall STRING, temperature STRING, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS recalculate_inventory (id INT, product_id INT, `date` DATE, opening_quantity DECIMAL, delivery_in_quantity DECIMAL, delivery_out_quantity DECIMAL, closing_quantity DECIMAL, opening_cost DECIMAL, delivery_in_cost DECIMAL, delivery_out_cost DECIMAL, closing_cost DECIMAL, opening_quantity_kgs DECIMAL, delivery_in_quantity_kgs DECIMAL, delivery_out_quantity_kgs DECIMAL, closing_quantity_kgs DECIMAL, dirty TINYINT, barcode STRING, variant_1 INT, variant_2 INT, variant_3 INT, variant_4 STRING, variant_5 STRING, variant_6 STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS receipt_book_leafs (id INT, receipt_number STRING, receipt_book_id INT, status TINYINT, voucher_id INT, issue_date DATE, amount DECIMAL, party_id INT, employee_id INT, employee_id2 INT, payment_method INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, description STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS receipt_books (id INT, receipt_book_no STRING, leaf_prefix STRING, branch_id INT, first_receipt_no INT, number_of_leafs INT, issue_date DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, user_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS receive_sample_orders (id INT, sample_type INT, placement_status INT, factory_id INT, factory_date DATE, shipping_date DATE, delivery_date DATE, reject_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS receive_workorders (id INT, delivery_date STRING, payment_method_type STRING, shipping_address_id INT, billing_address_id INT, total_promotional_discount DECIMAL, total_trade_discount DECIMAL, total_general_discount DECIMAL, total_special_discount DECIMAL, special_discount_percent DECIMAL, sub_total DECIMAL, src_discount DECIMAL, coupon_discount DECIMAL, till_date DATE, total_discount_3 DECIMAL, total_discount_4 DECIMAL, total_discount_5 DECIMAL, source_port INT, destination_port INT, is_cmt INT, common_sizes STRING, common_colors STRING, common_styles STRING, common_quantity DECIMAL, common_rpu DECIMAL, acceptance_qualtity_level DECIMAL, tna_id INT, latitude DECIMAL, longitude DECIMAL, party_type STRING, sub_type INT, post_latitude DECIMAL, post_longitude DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS refund (id INT, employee_id INT, payroll_item_id INT, rate DECIMAL, total_amount DECIMAL, paid_amount DECIMAL, `start` DATE, `end` DATE, paid_upto DATE, refund_date DATE, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS refund_details (id INT, refund_id INT, employee_id INT, schedule_id INT, payroll_earning_id INT, payroll_payment_id INT, `date` DATE, amount DECIMAL, refund_amount DECIMAL, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS refund_histories (id INT, refund_id INT, voucher_id INT, type INT, `date` DATE, amount DECIMAL, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, employee_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS regions (id INT, name STRING, code STRING, party_id INT, start_date DATE, description STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS registered_accessories (id INT, machine_id INT, accessory_id INT, product_id INT, registered_machine_id INT, serial_1 STRING, serial_2 STRING, serial_3 STRING, serial_4 STRING, serial_5 STRING, serial_6 STRING, registration_name STRING, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated INT, updated_by TIMESTAMP, status INT, health DECIMAL, maintenance_start DATE, vendor_id INT, part_number STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS registered_machine_maintenance_frequencies (id INT, name STRING, frequency INT, registered_machine_id INT, maintenance_duration INT, start_date DATE, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP) STORED AS ORC

CREATE TABLE IF NOT EXISTS registered_machineries (id INT, machine_id INT, product_id INT, serial_1 STRING, serial_2 STRING, serial_3 STRING, serial_4 STRING, serial_5 STRING, serial_6 STRING, registration_name STRING, status INT, health DECIMAL, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated INT, updated_by TIMESTAMP, maintenance_start DATE, vendor_id INT, part_number STRING, branch_id INT, registration_alias STRING, last_schedule_date DATE, prod_unit_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS registrations_of_basic_information (id INT, name STRING, father_name STRING, address STRING, phone_no STRING, nationality STRING, date_of_birth DATE, gurdian_name STRING, serial_1 STRING, serial_2 STRING, year_of_mfg STRING, previous_reg_no STRING, p_o_bank STRING, sex INT, created TIMESTAMP, updated TIMESTAMP, created_by STRING, updated_by STRING, inactive TINYINT, deleted TINYINT, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS requisitions (id INT, department_id INT, requisition_date DATE, description STRING, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, sheet STRING, party_id INT, type INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS rm_room_booking_items (id INT, booking_id INT, room_id INT, bed_id STRING, start_date DATE, end_date DATE, quantity INT, vat_percent DECIMAL, total_vat DECIMAL, discount_percent DECIMAL, discount DECIMAL, unit_cost DECIMAL, created TIMESTAMP, updated TIMESTAMP, inactive INT, deleted INT, checkout_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS rmg_chartmakings (id INT, name STRING, code STRING, sample_request_id INT, style_id INT, size_id INT, template_id INT, weight DECIMAL, gauge DECIMAL, yarn STRING, `date` DATE, tension STRING, body STRING, back STRING, rib STRING, cross_point DECIMAL, needle_point DECIMAL, created TIMESTAMP, UPDATEd TIMESTAMP, created_by INT, UPDATEd_by INT, inactive INT, deleted INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS rmg_cutting_entries (id INT, code STRING, ref_no STRING, style_id INT, buyer_order_id INT, production_order_id INT, season STRING, planned_start_date DATE, planned_end_date DATE, delivery_date DATE, cut_no STRING, cut_method INT, cut_id STRING, `date` DATE, table_no STRING, start_time TIMESTAMP, end_time TIMESTAMP, production_unit_id INT, colors STRING, no_of_piles INT, marker_id INT, total_quantity INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS rmg_cutting_marker_info (id INT, pattern_id INT, style_id INT, marker_length DECIMAL, marker_length_uom_id INT, marker_width DECIMAL, marker_width_uom_id INT, fabrics_lay_length DECIMAL, fabrics_lay_length_uom_id INT, fabrics_lay_width DECIMAL, fabrics_lay_width_uom_id INT, efficiency DECIMAL, `date` DATE, marker_created_by INT, color_list STRING, size_list STRING, status INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS rmg_pattern_marker (id INT, name STRING, style_id INT, template_id INT, `date` DATE, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS rmg_sample_requests (id INT, order_no STRING, gauge STRING, yearn_composition STRING, accessories STRING, measurement_specification STRING, quantity STRING, submission_date DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT, product_id INT, style_id INT, measurement_chart STRING, swatch STRING, special_instruction STRING, remarks STRING, sample_type_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS route_visits (id INT, route_id INT, start_date DATE, end_date DATE, employee_id INT, code STRING, visit_frequency INT, visit_day INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS sale_incentive_new_configs (id INT, name STRING, start_date DATE, end_date DATE, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, customer_category_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS sale_incentive_process (id INT, product_id INT, category_id_1 INT, category_id_2 INT, category_id_3 INT, category_id_4 INT, calculation_on INT, is_progressive INT, customer_category_id INT, incentive_type_id INT, payment_method_id INT, voucher_branch_id INT, frequency_id INT, from_date DATE, to_date DATE, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, process_number STRING, incentive_based_on INT, voucher_id INT, config_id INT, voucher_done INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS sales_commission_generate_payments (id INT, sales_commission_id INT, employee_id INT, total_commission DECIMAL, voucher_id INT, from_date DATE, to_date DATE, paid_status INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS sales_commissions (id INT, name STRING, model INT, type INT, rate INT, payment_option INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, start_date DATE, end_date DATE, last_paid_date DATE, plan_period INT, branch_id INT, target_type INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS sales_location_details (id INT, sales_location_id INT, employee_id INT, branch_id INT, start_date DATE, end_date DATE, replacement_employee_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS sales_location_manager (id INT, sales_location_id INT, employee_id INT, start_date DATE, end_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS sales_targets (id INT, name STRING, start_date DATE, end_date DATE, target DECIMAL, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, branch_id INT, is_month_end INT, is_kpi_data_processed INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS sales_team_details (id INT, sales_team_id INT, department_id INT, employee_id INT, is_team_lead INT, start_date DATE, End_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS sales_tier_details (id INT, sales_tier_id INT, sales_location_id INT, employee_id INT, start_date DATE, end_date DATE, layer_id INT, parent_id INT, division_id INT, district_id INT, thana_id INT, union_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS sales_tier_employee (id INT, sales_tier_id INT, employee_id INT, start_date DATE, end_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS sample_deliveries (id INT, delivery_date DATE, order_id INT, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP) STORED AS ORC

CREATE TABLE IF NOT EXISTS sample_delivery_products (id INT, delivery_id INT, product_id INT, quantity DECIMAL) STORED AS ORC

CREATE TABLE IF NOT EXISTS sample_enquiries (id INT, customer_id INT, enquiry_date DATE, completion_date DATE, status INT, factory_date DATE, delivery_date DATE, shipping_date DATE, factory_id INT, sample_type INT, reject_date DATE, active_status INT, currency_id STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS sample_order_placement_histories (id INT, order_id INT, previous_status INT, current_status INT, change_date DATE, created_by INT, created TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS security_deposits (id INT, payment_method INT, cheque_date DATE, cheque_number STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS send_sample_orders (id INT, sample_type INT, placement_status INT, factory_id INT, factory_date DATE, shipping_date DATE, delivery_date DATE, reject_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS service_contract_product_price_changes (id INT, service_contract_product_id INT, product_id INT, quantity DECIMAL, unit_cost DECIMAL, vat_percent DECIMAL, vat DECIMAL, total DECIMAL, discount DECIMAL, start_date DATE, bill_starts DATE, end_date DATE, last_billed DATE, next_bill DATE, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS service_contract_products (id INT, service_contract_id INT, service_uid STRING, party_id INT, billingcycle_id INT, cyclewise_billing TINYINT, start_date DATE, bill_starts DATE, end_date DATE, last_billed DATE, second_last_billed DATE, next_bill DATE, ondemand_bill INT, product_id INT, quantity DECIMAL, unit_cost DECIMAL, discount DECIMAL, vat_percent DECIMAL, vat DECIMAL, total DECIMAL, service_package_id INT, connectivity_status INT, inactive TINYINT, agreement_type INT, outline_id INT, deleted TINYINT, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, unit_of_measurement_id INT, branch_id INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, project_id INT, contact_person_id INT, connection_type INT, connectivity_type INT, allocated_ip STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS service_contract_products_history (id INT, party_id INT, service_contract_id INT, service_package_id INT, service_contract_product_id INT, service_uid STRING, billingcycle_id INT, cyclewise_billing TINYINT, product_id INT, quantity DECIMAL, unit_cost DECIMAL, discount DECIMAL, vat_percent DECIMAL, vat DECIMAL, total DECIMAL, bill_date DATE, due_date DATE, bill_status INT, bill_type INT, modify_date DATE, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, unit_of_measurement_id INT, branch_id INT, deleted TINYINT, start_date DATE, end_date DATE, project_id INT, type INT, connection_type INT, connectivity_type INT, allocated_ip STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS service_contract_request_products (id INT, service_contract_request_id INT, service_uid STRING, party_id INT, billingcycle_id INT, cyclewise_billing TINYINT, start_date DATE, bill_starts DATE, end_date DATE, last_billed DATE, second_last_billed DATE, next_bill DATE, ondemand_bill INT, product_id INT, quantity DECIMAL, unit_cost DECIMAL, discount DECIMAL, vat_percent DECIMAL, vat DECIMAL, total DECIMAL, service_package_id INT, connectivity_status INT, inactive TINYINT, deleted TINYINT, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, unit_of_measurement_id INT, branch_id INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, project_id INT, connection_type INT, connectivity_type INT, allocated_ip STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS service_contract_requests (id INT, name STRING, code STRING, party_id INT, branch_id INT, contract_id INT, service_package_id INT, discount DECIMAL, start_date DATE, end_date DATE, activation_date DATE, billed_upto DATE, description STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, deleted TINYINT, inactive TINYINT, status TINYINT, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, ref_survey_response INT, project_id INT, type INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS service_contracts (id INT, name STRING, code STRING, party_id INT, branch_id INT, service_package_id INT, discount DECIMAL, start_date DATE, end_date DATE, activation_date DATE, billed_upto DATE, description STRING, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, deleted TINYINT, inactive TINYINT, down_payment DECIMAL, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, ref_survey_response INT, commercial_docs_id INT, project_id INT, type INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS service_discontinuation_requests (id INT, product_id INT, party_id INT, service_contract_product_id INT, service_contract_id INT, service_package_id INT, billingcycle_id INT, unit_cost DECIMAL, quantity DECIMAL, unit_of_measurement_id INT, total DECIMAL, adjustment_amount DECIMAL, apply_date DATE, request_date DATE, requested_by INT, approved_by INT, approve_date DATE, request_status INT, branch_id INT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, description STRING, accepted_by INT, accepted_date DATE, transaction_id INT, own_approval INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS service_ledgers (id INT, party_id INT, service_contract_id INT, service_package_id INT, service_contract_product_id INT, billingcycle_id INT, product_id INT, quantity DECIMAL, unit_cost DECIMAL, total DECIMAL, start_date DATE, end_date DATE, bill_date DATE, due_date DATE, invoice_number STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS service_packages (id INT, name STRING, start_date DATE, end_date DATE, description STRING, amount DECIMAL, custom TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, deleted TINYINT, inactive TINYINT, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, branch_id INT, duration INT, duration_calculation_type INT, sequence_number INT, total_disc_amount DECIMAL, net_amount DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS service_updown_requests (id INT, product_id INT, party_id INT, service_contract_product_id INT, service_contract_id INT, service_package_id INT, billingcycle_id INT, unit_cost DECIMAL, quantity DECIMAL, unit_of_measurement_id INT, total DECIMAL, adjustment_amount DECIMAL, apply_date DATE, request_date DATE, requested_by INT, approved_by INT, approve_date DATE, request_status INT, branch_id INT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, description STRING, accepted_by INT, accepted_date DATE, transaction_id INT, own_approval INT, in_progress_by INT, reviewed_by INT, updown_type INT, ref_doc_id INT, expiry_date TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS shift_info_temporary (id BIGINT, employee_id INT, start_limit TIMESTAMP, end_limit TIMESTAMP, entry_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS shift_rosters (id BIGINT, employee_id INT, shift_schedule_id INT, work_date DATE, is_holiday TINYINT, is_swap TINYINT, swap_employee_id INT, application_id INT, prev_shift_schedule_id INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive TINYINT, deleted TINYINT, shift_rosters_batch_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS shift_rosters_batch (id INT, code STRING, status INT, entry_date DATE, col_names STRING, created_by INT, approved_by INT, updated_by INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, copy_employees STRING, type INT, source_employee INT, branch_id INT, designation_id INT, department_id INT, month INT, transaction_id INT, own_approval INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS shift_rosters_batch_details (id INT, employee_id INT, shift_rosters_batch_id INT, shift_schedule_id INT, work_date DATE, is_holiday INT, is_swap INT, swap_employee_id INT, application_id INT, prev_shift_schedule_id INT, created TIMESTAMP, updated TIMESTAMP, created_by STRING, updated_by STRING, inactive INT, deleted INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS shift_swaps (id INT, employee_id INT, application_date DATE, current_shift_schedule_id INT, swap_shift_schedule_id INT, work_date DATE, swap_employee_id INT, recommended_by INT, approved_by INT, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive TINYINT, deleted TINYINT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS shipment_information (id INT, voucher_id INT, commercial_doc_id INT, assort STRING, quantity DECIMAL, amount DECIMAL, destination_port INT, origin_port INT, party_id INT, shipment_date DATE, mms_shipment_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS shipment_items (id INT, shipment_qty DECIMAL, received_qty DECIMAL, qc_passed_qty DECIMAL, qc_failed_qty DECIMAL, excess_qty DECIMAL, missing_qty DECIMAL, passed_processed DECIMAL, failed_processed DECIMAL, excess_processed DECIMAL, missing_processed DECIMAL, missing_amount DECIMAL, qc_rejected_amount DECIMAL, amount_calculation_date DATE, item_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS shipment_losses (id INT, shipment_id INT, calculation_date DATE, amount DECIMAL, product_wise_costing TINYINT, description STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS shipment_schedule (id INT, pi_id INT, total_containers INT, assessment_date DATE, ci_id INT, no_of_container INT, tent_factory_dispatch_date DATE, tent_document_date DATE, tent_document_release_date DATE, tent_landing_date_port DATE, tent_landing_date_wh DATE, tent_assessment_date DATE, tent_shipping_date DATE, port_assessment_days INT, shipping_mode INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS shipment_schedule_histories (id INT, shipment_schedule_id INT, pi_id INT, ci_id INT, total_containers INT, no_of_container INT, tent_factory_dispatch_date DATE, tent_document_date DATE, tent_shipping_date DATE, tent_document_release_date DATE, tent_landing_date_port DATE, tent_landing_date_wh DATE, tent_assessment_date DATE, port_assessment_days INT, description STRING, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP) STORED AS ORC

CREATE TABLE IF NOT EXISTS shipments (id INT, ship_no STRING, order_id INT, po_id INT, net_weight DECIMAL, net_weight_uom INT, gross_weight DECIMAL, gross_weight_uom INT, from_branch_id INT, to_branch_id INT, to_inventory_id INT, next_action INT, schedule_no_id INT, qc_passed_qty DECIMAL, qc_failed_qty DECIMAL, excess_qty DECIMAL, missing_qty DECIMAL, in_charge INT, cost_challan_no STRING, cost_delivery_date DATE, cost_receive_date DATE, qc_challan_no STRING, qc_receive_date DATE, qc_delivery_date DATE, status INT, from_inventory_id INT, wo_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS special_allowance_requisition (id INT, employee_id INT, requisition_type INT, `date` DATE, amount DECIMAL, status INT, inactive INT, deleted INT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, hour INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS stationery_assignment_items (id INT, parent_doc_id INT, employee_id INT, department_id INT, expiry_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS stationery_ledgers (id INT, entry_date DATE, order_id INT, commercial_doc_id INT, employee_id INT, department_id INT, branch_id INT, product_id INT, quantity DECIMAL, expiry_date TIMESTAMP, inactive INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, transfer_type INT, transfer_from INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS status_histories (id INT, table_name STRING, table_key INT, `date` DATE, previous_status INT, current_status INT, ip STRING, created_by INT, created TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS style_order_wise_tna_events (id INT, days INT, buffer INT, start_date DATE, end_date DATE, end_date_with_buffer DATE, event_id INT, tna_template_id INT, style_id INT, style_order_id INT, predecessor_id INT, execution_order INT, status INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, inactive INT, deleted INT, algo_type INT, complete_percent DECIMAL, complete_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS survey (id INT, title STRING, topic STRING, type INT, target_party STRING, estimated_outcome DECIMAL, budget DECIMAL, start_date DATE, end_date DATE, campaign_id INT, survey_lead_id INT, assigned_to INT, branch_id INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, description STRING, survey_number STRING, project_id INT, model_type INT, training_requisition_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS survey_basics (id INT, survey_number STRING, title STRING, description STRING, survey_type STRING, start_date DATE, end_date DATE, project_id INT, inactive INT, deleted INT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP, parent_survey_basic_id INT, survey_stage INT, template_for STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS suspensions (id INT, employee_id INT, `start` DATE, `end` DATE, reason STRING, deleted INT, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS sync_post_history (id INT, ref_no STRING, key STRING, type INT, data STRING, from_date DATE, last_sync_date TIMESTAMP, to_date DATE, custom_field_1 STRING, custom_field_2 STRING, custom_field_3 STRING, custom_field_4 STRING, status INT, state INT, server_msg STRING, description STRING, created TIMESTAMP, created_by STRING, inactive TINYINT, deleted TINYINT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS task_assignee (id INT, task_id INT, assigned_to_type INT, assigned_to INT, assigning_date DATE, status INT, effort_time INT, extra_effort_time INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS task_assignment_details (id INT, task_id INT, task_assignment_id INT, note STRING, assignment_number STRING, start_time STRING, end_time STRING, start_date DATE, end_date DATE, duration STRING, status INT, cost INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS task_assignments (id INT, assigned_to INT, supervised_by INT, assigning_date DATE, inactive TINYINT, deleted TINYINT, created_by INT, created TIMESTAMP, updated_by INT, updated TIMESTAMP) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS task_work_entries (id INT, task_id INT, entry_date DATE, start_time STRING, end_time STRING, effort_time DECIMAL, assigned_to INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS tasks (id INT, name STRING, goal_id INT, description STRING, entry_date DATE, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, inactive TINYINT, deleted TINYINT, start_time TIMESTAMP, end_time TIMESTAMP, delivery_deadline TIMESTAMP, estimated_done_time STRING, assigned_to STRING, supervisor_id INT, duration DECIMAL, duration_unit INT, duration_seconds INT, code STRING, branch_id INT, is_recurrent INT, is_milestone INT, is_estimated INT, effort_time INT, extra_effort_time INT, status INT, priority INT, priority_order INT, parent_id INT, level INT, color STRING, `order` INT, is_special_event INT, constraint_type STRING, constraint_date TIMESTAMP, locked INT, percent_done DECIMAL, type INT, actual_start_time TIMESTAMP, actual_end_time TIMESTAMP, is_group INT, is_backlog INT, source_type STRING, source_id INT, project_id INT, customer_id INT, reviewer_id INT, is_assigned INT, team_id INT, category_1 INT, category_2 INT, category_3 INT, category_4 INT, is_parent INT, task_complexity_level INT, parent_child_map STRING, parent_task_code STRING, task_add_outline_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS tax_rules (id INT, gender INT, age_from DECIMAL, age_to DECIMAL, disabled INT, country_id INT, `start` DATE, `end` DATE, maximum_rate DECIMAL, minimum_tax DECIMAL, version INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS taxes (id INT, name STRING, gst_type INT, start_from DATE, registration_no STRING, fill_frequency INT, rate DECIMAL, description STRING, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, account_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS tea_employee_task (id INT, task_management_id INT, task_type_id INT, employee_id INT, work_amount INT, planned_work_amount INT, unit_of_measurement_id INT, entry_time STRING, entry_date DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, status INT, rate DECIMAL, piece_rate_id INT, piecework_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS tea_task_management (id INT, program_book_id INT, task_type_id INT, branch_id INT, target_total INT, unit_of_measurement_id INT, planned_resource INT, contractor INT, total INT, resource INT, creation_date DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, rate DECIMAL) STORED AS ORC

CREATE TABLE IF NOT EXISTS team_assignments (id INT, model_name STRING, model_key INT, team_id INT, effective_from DATE, end_date DATE, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, inactive INT, deleted INT, team_list STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS team_members (id INT, team_id INT, team_member_type STRING, party_id INT, team_member_name STRING, team_role_id INT, team_role STRING, effective_from DATE, end_date DATE, engagement_percentage INT, supervisor_id INT, manager_id INT, branch_id INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, inactive INT, deleted INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS teams (id INT, name STRING, team_type_id INT, branch_id INT, team_lead_id INT, effective_from DATE, end_date DATE, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, inactive INT, deleted INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS temp_account_balances (id INT, account_id INT, balance_date DATE, amount DECIMAL, account_amount DECIMAL, party_amount DECIMAL, dirty TINYINT, branch_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS temp_account_balances_version_two (id INT, account_id INT, balance_date DATE, amount DECIMAL, account_amount DECIMAL, party_amount DECIMAL, dirty TINYINT, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS temp_cached_account_balances (id INT, account_id INT, balance_date DATE, amount DECIMAL, account_amount DECIMAL, party_amount DECIMAL, dirty TINYINT, branch_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS temp_cost_center_wise_account_balances (id INT, cost_center_id INT, account_id INT, from_date DATE, to_date DATE, amount DECIMAL, debit_amount DECIMAL, credit_amount DECIMAL, account_amount DECIMAL) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS tickets (id INT, ticket_number STRING, thread_id STRING, requester STRING, subject STRING, description STRING, assignee INT, assigned_to INT, status INT, module_id INT, ticket_type INT, subtype INT, outline_id INT, ref_ticket_id INT, priority INT, branch_id INT, support_seen TINYINT, seen_list STRING, unseen_list STRING, estimated_resolve_date DATE, resolve_date TIMESTAMP, updated_by INT, updated TIMESTAMP, requested_by INT, created TIMESTAMP, created_by INT, requested_at TIMESTAMP, inactive TINYINT, deleted TINYINT, outline_level_id INT, last_replied_by INT, last_reply_time TIMESTAMP, estimated_resolve_time STRING, project_id INT, source_id INT, remarks STRING, problem_id_list STRING, module_id_list STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS tiffin_bill_config_info (id INT, shift_id INT, hour INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS tm_employee_mapper_edit_logs (id INT, organogram_id INT, start_date DATE, end_date DATE, effective_date DATE, party_id INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, supervisor_id INT, field_officer INT, edited_by INT, edited_at TIMESTAMP, previous_data STRING, updated_data STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS tm_territory_employee_mappers (id INT, organogram_id INT, start_date DATE, end_date DATE, effective_date DATE, party_id INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, supervisor_id INT, field_officer INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS tna_event_date_change_logs (id INT, style_order_id INT, style_order_wise_tna_event_id INT, event_id INT, tna_id INT, prev_start_date DATE, curr_start_date DATE, prev_end_date DATE, curr_end_date DATE, prev_end_date_with_buffer DATE, curr_end_date_with_buffer DATE, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, inactive INT, deleted INT, curr_days INT, curr_buffer INT, prev_days INT, prev_buffer INT, prev_status INT, curr_status INT, prev_complete_percent DECIMAL, curr_complete_percent DECIMAL, permission INT, algo_type INT, option INT, remarks STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS tokens (id INT, auth_key STRING, type INT, table_name STRING, table_key INT, user_id INT, entry_date DATE, visited TINYINT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS trainee_attendances (id INT, trainee_id INT, training_schedule_id INT, `date` DATE, status INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS training_requisitions (id INT, name STRING, training_schedule_id INT, department_id INT, requisition_date DATE, status INT, recommended_by INT, recommend_date DATE, approved_by INT, approve_date DATE, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, own_approval INT, transaction_id INT, training_requisition_number STRING, branch_id INT, training_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS training_schedule_details (id INT, training_schedule_id INT, trainer_id INT, venue_id INT, `date` DATE, `start` STRING, `end` STRING, session_info STRING, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, session_link STRING) STORED AS ORC

CREATE TABLE IF NOT EXISTS training_schedules (id INT, name STRING, training_id INT, code STRING, description STRING, duration STRING, from_date DATE, to_date DATE, training_type INT, training_category INT, status INT, training_organization_id INT, max_no_trainee STRING, actual_no_trainee STRING, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS training_vouchers (id INT, name STRING, training_schedule_id INT, account_id INT, amount DECIMAL, voucher_date DATE, status INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, branch_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS transfer_orders (id INT, order_id INT, shipment_date DATE) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS vendors (id INT, status INT, category INT, from_date DATE, assign_to INT, vendor_category_id INT, item_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS vessel_loadings (id INT, deliveries STRING, driver_name STRING, vehicle_no STRING, dispatch_from STRING, destination_to STRING, contact_no STRING, `date` DATE, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, inactive TINYINT) STORED AS ORC

CREATE TABLE IF NOT EXISTS vms_appointment_confirmor (id INT, employee_id INT, designated_confirmor_id INT, `start` DATE, `end` DATE, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS vms_appointment_requests (id INT, visitor_id INT, employee_name STRING, employee_department STRING, employee_designation STRING, room_no STRING, employee_id INT, appointment_date DATE, start_time STRING, duration INT, end_time STRING, status INT, purpose_id INT, purpose_description STRING, approved_by INT, confirmed_by INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, appointment_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS vms_appointments (id INT, code STRING, visitor_id INT, employee_id INT, `date` DATE, `start` STRING, `end` STRING, duration INT, status INT, approved_by INT, confirmed_by INT, appointment_request_id INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, purpose_id INT, purpose_description STRING, visit_room_no STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS warranty_claims (id INT, party_id INT, party_address STRING, party_name STRING, party_contact STRING, product_id INT, product_serial_no STRING, serial_2 STRING, serial_3 STRING, serial_4 STRING, serial_5 STRING, product_serial_prefix STRING, product_serial_suffix STRING, status INT, type STRING, warranty_claim_number STRING, description STRING, order_no STRING, delivery_no STRING, claim_date DATE, warranty_end_date DATE, notification_date DATE, challan_no STRING, damaged_inventory_delivery STRING, replace_challan_no STRING, replaced_product_id INT, replace_serial_no STRING, replace_serial_2 STRING, replace_serial_3 STRING, replace_serial_4 STRING, replace_serial_5 STRING, replaced_warranty_end_date DATE, parts_received_challan_no STRING, delivery_branch_id INT, branch_id INT, received_by_id INT, inactive TINYINT, deleted TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT, completed_time TIMESTAMP, completed_by INT, claim_for INT, additional_receive STRING, assigned_to INT, sales_status_verdict INT, verdict INT, service_status_verdict INT, set_status_date DATE, problems STRING, service_point_status INT, sales_center_status INT, assigned_branch INT, sc_status_date DATE, sc_assigned_branch INT, sc_assigned_to INT, sc_status_description STRING, service_center_status INT, quick_time_status INT, service_center_status_description STRING, service_center_status_date DATE, sales_center_status_description STRING, service_center_assigned_branch INT, sales_center_assigned_branch INT, service_center_assigned_employee INT, sales_center_assigned_employee INT, sales_center_status_date DATE, source_branch INT, dest_branch INT, accepted_by_dest_branch TINYINT, problem_detail STRING, third_party_name STRING, third_party_contact STRING, third_party_address STRING, ref_order_no STRING, ref_delivery_no STRING, ref_party_id INT, ref_party_name STRING, ref_party_contact STRING, ref_party_address STRING, supplier_status INT, supplier_status_verdict INT, supplier_status_date DATE, is_group_claim INT, parent_claim_id INT, last_status_id INT, job_for STRING, fleet_id INT, claim_time STRING, expected_delivery_date DATE, expected_delivery_time STRING, delivery_date DATE, delivery_time STRING, is_satisfied TINYINT, dissatisfaction_reasons STRING, satisfaction_level INT, customer_voices STRING, customer_voice_detail STRING, is_waiting TINYINT, quantity DECIMAL, mileage DECIMAL, spare_product_id INT, sale_date DATE, factory_delivery_date DATE, branch_name STRING, ref_warranty_claim_number STRING, is_posted INT, branch_code STRING, actual_branch_id INT, data_source STRING, is_gvs_module_on INT, service_package_id INT, bill_amount DECIMAL, bill_no STRING, billing_date DATE) STORED AS ORC

CREATE TABLE IF NOT EXISTS warranty_claims_status (id INT, entry_date DATE, description STRING, status INT, verdict INT, status_type INT, sales_center_branch INT, service_center_branch INT, warranty_claim_id INT, reference_claim_no STRING, assigned_to INT, inactive TINYINT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS warranty_confirmation_batches (id INT, party_id INT, other_party_id INT, product_id INT, serial STRING, entry_date DATE, code STRING, ref_voucher_no INT, ref_doc_number INT, status INT, inactive INT, deleted INT, created TIMESTAMP, created_by INT, updated TIMESTAMP, updated_by INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS warranty_confirmation_details (id INT, product_id INT, order_no STRING, delivery_no STRING, serial STRING, serials STRING, sl_prefix STRING, sl_start BIGINT, sl_end BIGINT, sl_suffix STRING, sl_count BIGINT, sl_length BIGINT, serial_1 STRING, serial_2 STRING, serial_3 STRING, serial_4 STRING, serial_5 STRING, file_id INT, lot_number STRING, entry_date DATE, expiry_date DATE, reference_number STRING, warranty_start DATE, div_no INT, warranty_end DATE, warranty_period INT, status INT, deleted TINYINT, inactive TINYINT, file TINYINT, created_by INT, updated_by INT, created TIMESTAMP, updated TIMESTAMP, delivery_ref_number STRING, description STRING, branch_id INT, inventory_id INT, is_transfer TINYINT, delivery_type INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS warranty_solutions (id INT, warranty_claim_id INT, warranty_product_id INT, status INT, description STRING, solution_date DATE, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, solution_voucher_id INT, original_serial STRING, replacement_serial STRING, replacement_inventory_id INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS welfare_funds (id INT, fund_number STRING, employee_id INT, entry_date DATE, incidence_date DATE, applied_amount DECIMAL, verified_amount DECIMAL, approved_amount DECIMAL, incidence_reason INT, status INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, inactive INT, deleted INT, description STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS work_delegations (id INT, employee_id INT, task_description STRING, from_date DATE, to_date DATE, requested_at TIMESTAMP, accepted_at TIMESTAMP, completed_at TIMESTAMP, accepted_by INT, status INT, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, code STRING, delegator_id INT) STORED AS ORC

CREATE TABLE IF NOT EXISTS work_from_home (id INT, employee_id INT, code STRING, application_type INT, from_date DATE, to_date DATE, status INT, total_days INT, comment STRING, approved_by INT, recommend_by INT, created TIMESTAMP, updated TIMESTAMP, inactive INT, deleted INT, attachment_id INT, start_time STRING, end_time STRING, time_duration STRING) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS workflow_configs (id INT, model STRING, event STRING, level_id INT, `order` INT, designation STRING, employee_list STRING, exception_rules STRING, effective_date_start DATE, effective_date_end DATE, inactive INT, deleted INT, created TIMESTAMP, updated TIMESTAMP, created_by INT, updated_by INT, level_label STRING, name STRING, branch_id INT, type INT, subtype INT, module STRING, tag_employees INT, workflow_type INT) STORED AS ORC
...
CREATE TABLE IF NOT EXISTS year_closing (id INT, closing_date DATE, description STRING, status INT, journal_id INT, created TIMESTAMP, created_by INT, total_income DECIMAL, total_expense DECIMAL, retained_earnings DECIMAL, closing_start DATE) STORED AS ORC